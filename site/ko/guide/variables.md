...
불구하고
[공식 영문 문서](https://github.com/tensorflow/docs/blob/master/site/en/guide/variables.md)의
...
텐서플로에서 하나의 변수는 하나의 파이썬 객체입니다. 레이어, 모델, 옵티마이저, 그리고 다른 관련된 도구들을 작성할때 모델 안에 있는 모든 변수의
리스트가 필요할 수 있습니다.
...
레이어를 구현하고 있다면 `tf.keras.Layer`가 기본 클래스로 더 좋을 수 있습니다. 인터페이스를 구현하는 것은 레이어가 케라스에 완전하게
