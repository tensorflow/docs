...
## TODO (b/196121447) Merge the TF1.x vs TF2 behavior guide with this guide
...
`tf.keras.optimizers`. The easiest way to automatically apply these renames is
to use the [v2 upgrade script](upgrade.ipynb).
...
[AutoGraph](../../guide/function.ipynb) converts a subset of Python constructs
...
[the guide](../../guide/function.ipynb).
