...
To use images as metadata, create a single sprite image
consisting of small thumbnails—one for each vector in the embedding. A sprite image
stores thumbnails for all the sample images in a single large image.
