...
Defined in [`tensorflow/python/debug/lib/debug_graphs.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/python/debug/lib/debug_graphs.py).
