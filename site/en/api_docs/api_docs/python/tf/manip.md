...
Defined in [`tensorflow/manip/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/manip/__init__.py).
...
[`roll(...)`](../tf/manip/roll): Rolls the elements of a tensor along an axis.
