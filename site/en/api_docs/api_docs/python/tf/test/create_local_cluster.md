...
* <b>`protocol`</b>: Communication protocol.  Allowed values are documented in
    the documentation of <a href="../../tf/train/Server"><code>tf.train.Server</code></a>.
...
of `num_workers` objects of type <a href="../../tf/train/Server"><code>tf.train.Server</code></a> (all running locally);
