...
Defined in [`tensorflow/python/ops/distributions/uniform.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/python/ops/distributions/uniform.py).
