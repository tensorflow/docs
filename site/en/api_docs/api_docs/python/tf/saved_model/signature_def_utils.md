...
Defined in [`tensorflow/saved_model/signature_def_utils/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/saved_model/signature_def_utils/__init__.py).
