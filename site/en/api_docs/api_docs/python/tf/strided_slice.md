...
**Most users will want to use [`tf.Tensor.__getitem__`](../tf/Tensor#__getitem__) and
[`tf.Variable.__getitem__`](../tf/Variable#__getitem__).** That allows  NumPy style slicing syntax (i.e.
