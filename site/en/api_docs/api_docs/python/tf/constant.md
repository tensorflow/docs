...
Defined in [`tensorflow/python/framework/constant_op.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/framework/constant_op.py).
