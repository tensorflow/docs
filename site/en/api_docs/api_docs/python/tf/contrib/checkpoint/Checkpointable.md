...
Defined in [`tensorflow/python/training/checkpointable/tracking.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/training/checkpointable/tracking.py).
