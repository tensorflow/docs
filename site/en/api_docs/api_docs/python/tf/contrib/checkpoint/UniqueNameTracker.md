...
Defined in [`tensorflow/contrib/checkpoint/python/containers.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/checkpoint/python/containers.py).
