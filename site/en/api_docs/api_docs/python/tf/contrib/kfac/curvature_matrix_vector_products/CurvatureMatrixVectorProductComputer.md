...
Defined in [`tensorflow/contrib/kfac/python/ops/curvature_matrix_vector_products.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/kfac/python/ops/curvature_matrix_vector_products.py).
