...
Defined in [`tensorflow/contrib/kfac/python/ops/loss_functions_lib.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/kfac/python/ops/loss_functions_lib.py).
...
[`insert_slice_in_zeros(...)`](../../../tf/contrib/kfac/loss_functions/insert_slice_in_zeros): Inserts slice into a larger tensors of zeros.
