...
Defined in [`tensorflow/contrib/keras/python/keras/layers/convolutional_recurrent.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.3/tensorflow/contrib/keras/python/keras/layers/convolutional_recurrent.py).
