...
Defined in [`tensorflow/contrib/keras/python/keras/layers/advanced_activations.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.3/tensorflow/contrib/keras/python/keras/layers/advanced_activations.py).
