...
# tf.contrib.keras.layers.TimeDistributed

## Class `TimeDistributed`

Inherits From: [`Wrapper`](../../../../tf/contrib/keras/layers/Wrapper)



Defined in [`tensorflow/contrib/keras/python/keras/layers/wrappers.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.3/tensorflow/contrib/keras/python/keras/layers/wrappers.py).
