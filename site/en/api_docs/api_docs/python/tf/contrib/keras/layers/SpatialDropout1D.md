...
Inherits From: [`Dropout`](../../../../tf/contrib/keras/layers/Dropout)



Defined in [`tensorflow/contrib/keras/python/keras/layers/core.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.3/tensorflow/contrib/keras/python/keras/layers/core.py).
