...
Defined in [`tensorflow/contrib/keras/python/keras/layers/normalization.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.3/tensorflow/contrib/keras/python/keras/layers/normalization.py).
