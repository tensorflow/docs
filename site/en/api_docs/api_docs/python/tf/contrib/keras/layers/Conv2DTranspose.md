...
* Class `tf.contrib.keras.layers.Conv2DTranspose`
* Class `tf.contrib.keras.layers.Convolution2DTranspose`



Defined in [`tensorflow/contrib/keras/python/keras/layers/convolutional.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.3/tensorflow/contrib/keras/python/keras/layers/convolutional.py).
