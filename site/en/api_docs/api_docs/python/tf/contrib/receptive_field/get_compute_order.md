...
Defined in [`tensorflow/contrib/receptive_field/python/util/graph_compute_order.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/receptive_field/python/util/graph_compute_order.py).
