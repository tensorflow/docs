...
Defined in [`tensorflow/contrib/graph_editor/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/graph_editor/__init__.py).
...
[`class SubGraphView`](../../tf/contrib/graph_editor/SubGraphView): A subgraph view on an existing <a href="../../tf/Graph"><code>tf.Graph</code></a>.
...
[`copy_op_handler(...)`](../../tf/contrib/graph_editor/copy_op_handler): Copy a <a href="../../tf/Operation"><code>tf.Operation</code></a>.
...
[`get_ops_ios(...)`](../../tf/contrib/graph_editor/get_ops_ios): Return all the <a href="../../tf/Operation"><code>tf.Operation</code></a> which are connected to an op in ops.
...
[`get_within_boundary_ops(...)`](../../tf/contrib/graph_editor/get_within_boundary_ops): Return all the <a href="../../tf/Operation"><code>tf.Operation</code></a> within the given boundary.
...
[`make_list_of_op(...)`](../../tf/contrib/graph_editor/make_list_of_op): Convert ops to a list of <a href="../../tf/Operation"><code>tf.Operation</code></a>.
