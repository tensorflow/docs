...
Defined in [`tensorflow/contrib/distribute/python/monitor.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/distribute/python/monitor.py).
