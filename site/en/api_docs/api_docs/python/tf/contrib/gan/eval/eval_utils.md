...
Defined in [`tensorflow/contrib/gan/python/eval/python/eval_utils.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/gan/python/eval/python/eval_utils.py).
