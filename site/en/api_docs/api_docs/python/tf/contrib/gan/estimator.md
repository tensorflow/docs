...
Defined in [`tensorflow/contrib/gan/python/estimator/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/gan/python/estimator/__init__.py).
