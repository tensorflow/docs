...
Defined in [`tensorflow/contrib/factorization/python/ops/kmeans.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/factorization/python/ops/kmeans.py).
...
* <b>`config`</b>: See [`tf.estimator.Estimator`](../../../tf/estimator/Estimator).
...
* <b>`input_fn`</b>: Input points. See [`tf.estimator.Estimator.predict`](../../../tf/estimator/Estimator#predict).
...
* <b>`input_fn`</b>: Input points. See [`tf.estimator.Estimator.evaluate`](../../../tf/estimator/Estimator#evaluate). Only one
      batch is retrieved.
