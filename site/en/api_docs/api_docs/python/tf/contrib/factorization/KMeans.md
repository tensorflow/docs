...
Defined in [`tensorflow/contrib/factorization/python/ops/clustering_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/factorization/python/ops/clustering_ops.py).
...
* <b>`inputs`</b>: An input tensor or list of input tensors
...
* <b>`cluster_centers_initialized`</b>: scalar indicating whether clusters have been
    initialized.
* <b>`cluster_centers_var`</b>: a Variable holding the cluster centers.
