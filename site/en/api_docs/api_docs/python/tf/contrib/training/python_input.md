...
Defined in [`tensorflow/contrib/training/python/training/python_input.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.3/tensorflow/contrib/training/python/training/python_input.py).
