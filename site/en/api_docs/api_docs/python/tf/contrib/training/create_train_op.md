...
Defined in [`tensorflow/contrib/training/python/training/training.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/training/python/training/training.py).
...
* <b>`update_ops`</b>: An optional list of updates to execute. If `update_ops` is
    ...
    it doesn't contain all of the update ops in <a href="../../../tf/GraphKeys#UPDATE_OPS"><code>tf.GraphKeys.UPDATE_OPS</code></a>,
