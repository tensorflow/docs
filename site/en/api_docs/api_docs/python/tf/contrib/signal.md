...
Defined in [`tensorflow/contrib/signal/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/signal/__init__.py).

Signal processing operations.

See the [Signal Processing (contrib)](../../../../api_guides/python/contrib.signal) guide.
