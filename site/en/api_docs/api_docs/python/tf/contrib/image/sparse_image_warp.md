...
Defined in [`tensorflow/contrib/image/python/ops/sparse_image_warp.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/image/python/ops/sparse_image_warp.py).
