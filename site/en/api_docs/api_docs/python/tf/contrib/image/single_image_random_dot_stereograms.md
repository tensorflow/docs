...
Defined in [`tensorflow/contrib/image/python/ops/single_image_random_dot_stereograms.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/image/python/ops/single_image_random_dot_stereograms.py).
