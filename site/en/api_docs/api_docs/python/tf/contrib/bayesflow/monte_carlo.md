...
Defined in [`tensorflow/contrib/bayesflow/python/ops/monte_carlo.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/bayesflow/python/ops/monte_carlo.py).
