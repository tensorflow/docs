...
Defined in [`tensorflow/contrib/bayesflow/python/ops/monte_carlo.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.3/tensorflow/contrib/bayesflow/python/ops/monte_carlo.py).
...
[`expectation_v2(...)`](../../../tf/contrib/bayesflow/monte_carlo/expectation_v2): Computes the Monte-Carlo approximation of `E_p[f(X)]`.
