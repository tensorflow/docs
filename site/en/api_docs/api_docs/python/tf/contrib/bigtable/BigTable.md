...
* Class `tf.contrib.bigtable.BigTable`
* Class `tf.contrib.cloud.BigTable`



Defined in [`tensorflow/contrib/bigtable/python/ops/bigtable_api.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/bigtable/python/ops/bigtable_api.py).
...
<a href="../../../tf/contrib/data/parallel_interleave"><code>tf.contrib.data.parallel_interleave</code></a> to construct a set of ranges for
