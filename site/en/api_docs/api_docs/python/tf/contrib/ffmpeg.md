...
Defined in [`tensorflow/contrib/ffmpeg/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/ffmpeg/__init__.py).

Working with audio using FFmpeg.

See the <a href="../../../../api_guides/python/contrib.ffmpeg">FFmpeg (contrib)</a> guide.
