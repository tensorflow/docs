...
Defined in [`tensorflow/contrib/linear_optimizer/python/ops/sdca_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/linear_optimizer/python/ops/sdca_ops.py).
