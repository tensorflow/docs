...
Defined in [`tensorflow/contrib/nn/python/ops/sampling_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/nn/python/ops/sampling_ops.py).
