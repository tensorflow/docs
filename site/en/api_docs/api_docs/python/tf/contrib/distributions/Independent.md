...
Defined in [`tensorflow/contrib/distributions/python/ops/independent.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/distributions/python/ops/independent.py).
...
<h3 id="reduce_batch_ndims"><code>reduce_batch_ndims</code></h3>
...
* <b>`reduce_batch_ndims`</b>: Scalar, integer number of rightmost batch dims which
...
* <b>`ValueError`</b>: if `reduce_batch_ndims` exceeds `distribution.batch_ndims`
