...
Defined in [`tensorflow/python/ops/distributions/normal.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/ops/distributions/normal.py).
