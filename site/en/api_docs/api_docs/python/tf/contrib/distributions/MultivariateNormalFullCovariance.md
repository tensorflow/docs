...
Defined in [`tensorflow/contrib/distributions/python/ops/mvn_full_covariance.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.3/tensorflow/contrib/distributions/python/ops/mvn_full_covariance.py).
