...
Defined in [`tensorflow/python/ops/distributions/gamma.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.3/tensorflow/python/ops/distributions/gamma.py).
