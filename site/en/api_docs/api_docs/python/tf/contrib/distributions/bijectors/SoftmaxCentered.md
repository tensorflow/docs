...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/softmax_centered_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.3/tensorflow/contrib/distributions/python/ops/bijectors/softmax_centered_impl.py).
