...
Defined in [`tensorflow/contrib/distributions/python/ops/poisson_lognormal.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/distributions/python/ops/poisson_lognormal.py).
...
* <b>`TypeError`</b>: if `loc.dtype != scale[0].dtype`.
