...
Defined in [`tensorflow/contrib/distributions/python/ops/relaxed_onehot_categorical.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/distributions/python/ops/relaxed_onehot_categorical.py).
...
followed by a <a href="../../../tf/exp"><code>tf.exp</code></a> op, is equivalent to evaluating KL divergences of
...
are followed by a <a href="../../../tf/exp"><code>tf.exp</code></a> op, then they are distributed as a relaxed onehot
categorical.
