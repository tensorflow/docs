...
Defined in [`tensorflow/contrib/distributions/python/ops/mixture_same_family.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/distributions/python/ops/mixture_same_family.py).
