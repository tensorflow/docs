...
Defined in [`tensorflow/contrib/distributions/python/ops/vector_diffeomixture.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/distributions/python/ops/vector_diffeomixture.py).
...
* <b>`quadrature_polynomial_degree`</b>: Python `int`-like scalar.
...
* <b>`ValueError`</b>: if `quadrature_polynomial_degree < 1`.
