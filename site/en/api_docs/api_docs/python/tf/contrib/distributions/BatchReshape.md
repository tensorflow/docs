...
Defined in [`tensorflow/contrib/distributions/python/ops/batch_reshape.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/distributions/python/ops/batch_reshape.py).
