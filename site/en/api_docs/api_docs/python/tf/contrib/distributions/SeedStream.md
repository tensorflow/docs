...
Defined in [`tensorflow/contrib/distributions/python/ops/seed_stream.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/distributions/python/ops/seed_stream.py).
