...
Defined in [`tensorflow/contrib/kernel_methods/python/losses.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/kernel_methods/python/losses.py).
