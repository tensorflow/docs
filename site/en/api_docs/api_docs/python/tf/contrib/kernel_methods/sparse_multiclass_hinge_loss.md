...
Defined in [`tensorflow/contrib/kernel_methods/python/losses.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/kernel_methods/python/losses.py).
