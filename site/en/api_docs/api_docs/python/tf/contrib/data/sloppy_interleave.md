...
Defined in [`tensorflow/contrib/data/python/ops/sloppy_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/data/python/ops/sloppy_ops.py).
