...
Defined in [`tensorflow/contrib/util/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/util/__init__.py).

Utilities for dealing with Tensors.

See [Utilities (contrib)](../../../../api_guides/python/contrib.util) guide.
