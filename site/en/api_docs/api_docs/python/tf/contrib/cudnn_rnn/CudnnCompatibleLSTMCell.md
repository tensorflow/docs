...
A simple wrapper around [`tf.contrib.rnn.LSTMBlockCell`](../../../tf/contrib/rnn/LSTMBlockCell) to use along with
[`tf.contrib.cudnn_rnn.CudnnLSTM`](../../../tf/contrib/cudnn_rnn/CudnnLSTM). The latter's params can be used by
