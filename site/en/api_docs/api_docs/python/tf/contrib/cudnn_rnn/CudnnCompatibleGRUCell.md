...
Inherits From: [`GRUCell`](../../../tf/contrib/rnn/GRUCell)



Defined in [`tensorflow/contrib/cudnn_rnn/python/ops/cudnn_rnn_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/cudnn_rnn/python/ops/cudnn_rnn_ops.py).

Cudnn Compatible GRUCell.

A GRU impl akin to <a href="../../../tf/contrib/rnn/GRUCell"><code>tf.nn.rnn_cell.GRUCell</code></a> to use along with
...
Other GRU (see <a href="../../../tf/contrib/rnn/GRUCell"><code>tf.nn.rnn_cell.GRUCell</code></a> and <a href="../../../tf/contrib/rnn/GRUBlockCell"><code>tf.contrib.rnn.GRUBlockCell</code></a>):
