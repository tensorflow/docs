...
Defined in [`tensorflow/contrib/cudnn_rnn/python/ops/cudnn_rnn_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/contrib/cudnn_rnn/python/ops/cudnn_rnn_ops.py).

Cudnn Compatible GRUCell.

A GRU impl akin to [`tf.nn.rnn_cell.GRUCell`](../../../tf/contrib/rnn/GRUCell) to use along with
...
Other GRU (see [`tf.nn.rnn_cell.GRUCell`](../../../tf/contrib/rnn/GRUCell) and [`tf.contrib.rnn.GRUBlockCell`](../../../tf/contrib/rnn/GRUBlockCell)):
```python
