...
Defined in [`tensorflow/python/pywrap_tensorflow_internal.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/pywrap_tensorflow_internal.py).
