...
Defined in [`tensorflow/contrib/cloud/python/ops/gcs_config_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/cloud/python/ops/gcs_config_ops.py).
