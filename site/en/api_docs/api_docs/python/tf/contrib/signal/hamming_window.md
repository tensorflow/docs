...
Defined in [`tensorflow/contrib/signal/python/ops/window_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/signal/python/ops/window_ops.py).
