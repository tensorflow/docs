...
Defined in [`tensorflow/contrib/saved_model/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/saved_model/__init__.py).
