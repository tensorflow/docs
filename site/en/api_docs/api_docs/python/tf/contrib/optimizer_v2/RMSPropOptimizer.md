...
Defined in [`tensorflow/contrib/optimizer_v2/rmsprop.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/optimizer_v2/rmsprop.py).
