...
Defined in [`tensorflow/python/data/ops/iterator_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/python/data/ops/iterator_ops.py).
...
it with the value of [`tf.data.Iterator.string_handle`](../../tf/data/Iterator#string_handle) in each step.
