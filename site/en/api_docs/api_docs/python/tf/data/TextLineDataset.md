...
Defined in [`tensorflow/python/data/ops/readers.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/python/data/ops/readers.py).
...
identical results = to [`tf.data.Dataset.flat_map`](../../tf/data/Dataset#flat_map). In general,
