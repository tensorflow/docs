...
Defined in [`tensorflow/python/ops/linalg/linear_operator_identity.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/ops/linalg/linear_operator_identity.py).
