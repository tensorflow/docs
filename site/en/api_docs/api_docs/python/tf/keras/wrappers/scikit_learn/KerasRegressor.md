...
Defined in [`tensorflow/python/keras/_impl/keras/wrappers/scikit_learn.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/python/keras/_impl/keras/wrappers/scikit_learn.py).
