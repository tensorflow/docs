...
Inherits From: [`BatchNormalization`](../../../tf/layers/BatchNormalization), [`Layer`](../../../tf/keras/layers/Layer)



Defined in [`tensorflow/python/keras/_impl/keras/layers/normalization.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/python/keras/_impl/keras/layers/normalization.py).
