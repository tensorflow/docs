...
Defined in [`tensorflow/python/keras/layers/normalization.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/keras/layers/normalization.py).
