...
Defined in [`tensorflow/python/keras/_impl/keras/layers/noise.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/python/keras/_impl/keras/layers/noise.py).
