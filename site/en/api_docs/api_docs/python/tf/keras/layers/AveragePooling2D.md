...
Inherits From: [`AveragePooling2D`](../../../tf/layers/AveragePooling2D), [`Layer`](../../../tf/keras/layers/Layer)
...
Defined in [`tensorflow/python/keras/_impl/keras/layers/pooling.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/python/keras/_impl/keras/layers/pooling.py).
