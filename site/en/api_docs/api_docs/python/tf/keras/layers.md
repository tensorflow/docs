...
Defined in [`tensorflow/python/keras/layers/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/python/keras/layers/__init__.py).
...
[`class InputLayer`](../../tf/keras/layers/InputLayer): Layer to be used as an entry point into a graph.

[`class InputSpec`](../../tf/layers/InputSpec): Specifies the ndim, dtype and shape of every input to a layer.

[`class LSTM`](../../tf/keras/layers/LSTM): Long-Short Term Memory unit - Hochreiter 1997.
