...
Defined in [`tensorflow/keras/applications/xception/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/keras/applications/xception/__init__.py).
