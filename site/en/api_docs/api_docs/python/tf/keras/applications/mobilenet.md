...
Defined in [`tensorflow/keras/applications/mobilenet/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/keras/applications/mobilenet/__init__.py).
