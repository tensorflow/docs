...
Defined in [`tensorflow/python/keras/applications/nasnet.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/keras/applications/nasnet.py).
