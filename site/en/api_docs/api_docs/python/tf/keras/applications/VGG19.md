...
Defined in [`tensorflow/python/keras/_impl/keras/applications/vgg19.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/python/keras/_impl/keras/applications/vgg19.py).
