...
Defined in [`tensorflow/python/keras/utils/multi_gpu_utils.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/keras/utils/multi_gpu_utils.py).
