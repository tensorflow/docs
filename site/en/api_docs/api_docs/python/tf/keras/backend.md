...
Defined in [`tensorflow/python/keras/backend/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/python/keras/backend/__init__.py).
...
[`count_params(...)`](../../tf/keras/backend/count_params): Returns the number of scalars in a Keras variable.
...
[`int_shape(...)`](../../tf/keras/backend/int_shape): Returns the shape tensor or variable as a tuple of int or None entries.
...
[`ones(...)`](../../tf/keras/backend/ones): Instantiates an all-ones tensor variable and returns it.
