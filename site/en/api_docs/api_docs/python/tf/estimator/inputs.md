...
Defined in [`tensorflow/python/estimator/api/estimator/inputs/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/estimator/api/estimator/inputs/__init__.py).
