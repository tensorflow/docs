...
Defined in [`tensorflow/python/estimator/canned/dnn_linear_combined.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.3/tensorflow/python/estimator/canned/dnn_linear_combined.py).
