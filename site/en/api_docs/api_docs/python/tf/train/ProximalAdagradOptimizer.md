...
Defined in [`tensorflow/python/training/proximal_adagrad.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/python/training/proximal_adagrad.py).
