...
Defined in [`tensorflow/python/profiler/tfprof_logger.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.4/tensorflow/python/profiler/tfprof_logger.py).
