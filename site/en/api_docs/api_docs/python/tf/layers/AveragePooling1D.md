...
Inherits From: [`AveragePooling1D`](../../tf/keras/layers/AveragePooling1D), [`Layer`](../../tf/layers/Layer)



Defined in [`tensorflow/python/layers/pooling.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/layers/pooling.py).
