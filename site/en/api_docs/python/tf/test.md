...
Defined in [`tensorflow/python/platform/test.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/python/platform/test.py).

Testing.

See the [Testing](../../../api_guides/python/test) guide.
