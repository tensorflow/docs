...
* <b>`filenames`</b>: A <a href="../../tf/dtypes#string"><code>tf.string</code></a> tensor or <a href="../../tf/data/Dataset"><code>tf.data.Dataset</code></a> containing one or
    more filenames.
...
* <b>`num_parallel_reads`</b>: (Optional.) A <a href="../../tf/dtypes#int64"><code>tf.int64</code></a> scalar representing the
