...
Defined in [`tensorflow/python/data/experimental/ops/get_single_element.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/data/experimental/ops/get_single_element.py).
