...
Defined in [`tensorflow/python/data/experimental/ops/resampling.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/data/experimental/ops/resampling.py).
