description: Returns the type specification of an element of a Dataset or Iterator.
...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r2.2/tensorflow/python/data/ops/dataset_ops.py#L2582-L2601">
...
<td>
If `dataset_or_iterator` is not a `Dataset` or `Iterator` object.
</td>
</tr>
</table>
