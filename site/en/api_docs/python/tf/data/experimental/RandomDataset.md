...
Defined in [`python/data/experimental/ops/random_ops.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/python/data/experimental/ops/random_ops.py).
...
Note that if the dataset was batched using <a href="../../../tf/data/Dataset#batch"><code>Dataset.batch</code></a>, each element is
