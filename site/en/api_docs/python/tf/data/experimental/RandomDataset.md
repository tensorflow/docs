...
Defined in [`tensorflow/python/data/experimental/ops/random_ops.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/data/experimental/ops/random_ops.py).
