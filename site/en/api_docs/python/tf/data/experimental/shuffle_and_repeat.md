...
Defined in [`tensorflow/python/data/experimental/ops/shuffle_ops.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/data/experimental/ops/shuffle_ops.py).
