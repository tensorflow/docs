description: Records the latency of producing each element of the input dataset.
...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r2.4/tensorflow/python/data/experimental/ops/stats_ops.py#L74-L94">
