...
* <b>`driver_name`</b>: A 0-D <a href="../../../tf/dtypes#string"><code>tf.string</code></a> tensor containing the database type.
    Currently, the only supported value is 'sqlite'.
* <b>`data_source_name`</b>: A 0-D <a href="../../../tf/dtypes#string"><code>tf.string</code></a> tensor containing a connection string
    to connect to the database.
* <b>`query`</b>: A 0-D <a href="../../../tf/dtypes#string"><code>tf.string</code></a> tensor containing the SQL query to execute.
