...
Defined in [`tensorflow/python/data/ops/dataset_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.11/tensorflow/python/data/ops/dataset_ops.py).

See the guides: [Dataset Input Pipeline](../../../../api_guides/python/input_dataset), [Reading data > `tf.data` API](../../../../api_guides/python/reading_data#_tf_data_API), [Threading and Queues > Queue usage overview](../../../../api_guides/python/threading_and_queues#Queue_usage_overview)
