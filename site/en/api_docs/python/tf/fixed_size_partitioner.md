...
Defined in [`tensorflow/python/ops/partitioned_variables.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/ops/partitioned_variables.py).
