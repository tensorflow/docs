...
Defined in [`tensorflow/python/saved_model/saved_model.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/python/saved_model/saved_model.py).
