...
<h3 id="__init__"><code>__init__(dtype, shape=None, shared_name=None, name='conditional_accumulator')</code></h3>
...
<h3 id="apply_grad"><code>apply_grad(grad, local_step=0, name=None)</code></h3>
