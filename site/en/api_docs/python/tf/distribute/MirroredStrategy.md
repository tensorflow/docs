...
Defined in [`tensorflow/python/distribute/mirrored_strategy.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/distribute/mirrored_strategy.py).
