...
Defined in [`python/distribute/collective_all_reduce_strategy.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/python/distribute/collective_all_reduce_strategy.py).
