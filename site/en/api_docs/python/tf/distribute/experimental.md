...
<td>
  <a target="_blank" href="/api_docs/python/tf/distribute/experimental">
...
[`class ParameterServerStrategy`](../../tf/distribute/experimental/ParameterServerStrategy): An asynchronous multi-worker parameter server tf.distribute strategy.
