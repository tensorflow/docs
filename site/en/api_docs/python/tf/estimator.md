...
Defined in [`tensorflow/python/estimator/estimator_lib.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/estimator/estimator_lib.py).
