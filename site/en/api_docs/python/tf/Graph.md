...
Defined in [`tensorflow/python/framework/ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/python/framework/ops.py).
...
[`GraphDef`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/core/framework/graph.proto).
...
#### Returns:
  ...
  A [`GraphDef`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/core/framework/graph.proto)
  protocol buffer.
...
[`DeviceNameUtils`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/core/util/device_name_utils.h).
