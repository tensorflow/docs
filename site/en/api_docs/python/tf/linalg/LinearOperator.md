...
Defined in [`tensorflow/python/ops/linalg/linear_operator.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/ops/linalg/linear_operator.py).
