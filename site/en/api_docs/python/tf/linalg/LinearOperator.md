...
Defined in [`tensorflow/python/ops/linalg/linear_operator.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/ops/linalg/linear_operator.py).
