...
Defined in [`python/ops/linalg/linear_operator_householder.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/python/ops/linalg/linear_operator_householder.py).
