...
Defined in [`tensorflow/python/ops/linalg/linear_operator_composition.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/ops/linalg/linear_operator_composition.py).
