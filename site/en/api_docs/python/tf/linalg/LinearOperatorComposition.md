...
Defined in [`tensorflow/python/ops/linalg/linear_operator_composition.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/python/ops/linalg/linear_operator_composition.py).
