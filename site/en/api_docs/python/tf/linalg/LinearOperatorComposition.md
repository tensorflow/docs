...
Defined in [`tensorflow/python/ops/linalg/linear_operator_composition.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/ops/linalg/linear_operator_composition.py).
