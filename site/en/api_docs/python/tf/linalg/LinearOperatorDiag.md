...
Defined in [`tensorflow/python/ops/linalg/linear_operator_diag.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/ops/linalg/linear_operator_diag.py).
