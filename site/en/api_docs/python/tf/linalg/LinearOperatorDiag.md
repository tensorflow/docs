...
Defined in [`tensorflow/python/ops/linalg/linear_operator_diag.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/ops/linalg/linear_operator_diag.py).
