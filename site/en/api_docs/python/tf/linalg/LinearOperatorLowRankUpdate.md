...
Defined in [`tensorflow/python/ops/linalg/linear_operator_low_rank_update.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/ops/linalg/linear_operator_low_rank_update.py).
