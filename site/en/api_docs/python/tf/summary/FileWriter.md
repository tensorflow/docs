...
<h3 id="__init__"><code>__init__(logdir, graph=None, max_queue=10, flush_secs=120, graph_def=None)</code></h3>
...
<h3 id="add_event"><code>add_event(event)</code></h3>
...
<h3 id="add_graph"><code>add_graph(graph, global_step=None, graph_def=None)</code></h3>
...
<h3 id="add_meta_graph"><code>add_meta_graph(meta_graph_def, global_step=None)</code></h3>
...
<h3 id="add_run_metadata"><code>add_run_metadata(run_metadata, tag, global_step=None)</code></h3>
...
<h3 id="add_session_log"><code>add_session_log(session_log, global_step=None)</code></h3>
...
<h3 id="add_summary"><code>add_summary(summary, global_step=None)</code></h3>
...
[`tf.Session.run`](../../tf/Session#run) or
[`tf.Tensor.eval`](../../tf/Tensor#eval), to this
