...
Defined in [`tensorflow/python/summary/writer/writer.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/summary/writer/writer.py).
