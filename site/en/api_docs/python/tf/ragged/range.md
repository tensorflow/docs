...
Defined in [`tensorflow/python/ops/ragged/ragged_math_ops.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/ops/ragged/ragged_math_ops.py).
