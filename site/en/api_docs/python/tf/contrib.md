...
Defined in [`tensorflow/contrib/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/__init__.py).
...
[`data`](../tf/contrib/data) module: `tf.contrib.data.Dataset` API for input pipelines.
...
[`learn`](../tf/contrib/learn) module: High level API for learning.
...
[`lite`](../tf/contrib/lite) module: TensorFlow Lite tooling helper functionality.
...
[`ndlstm`](../tf/contrib/ndlstm) module: Init file, giving convenient access to all ndlstm ops.
