...
Defined in [`tensorflow/contrib/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/__init__.py).
...
[`nn`](../tf/contrib/nn) module: Module for deprecated ops in tf.nn.
