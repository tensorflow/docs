...
Defined in [`tensorflow/contrib/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/__init__.py).
...
[`data`](../tf/contrib/data) module: `tf.contrib.data` API for input pipelines.
