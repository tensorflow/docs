...
Defined in [`tensorflow/python/profiler/option_builder.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/profiler/option_builder.py).
