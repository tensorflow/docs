...
Defined in [`tensorflow/python/profiler/tfprof_logger.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/profiler/tfprof_logger.py).
