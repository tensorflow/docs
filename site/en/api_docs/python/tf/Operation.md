...
<h3 id="__init__"><code>__init__(node_def, g, inputs=None, output_types=None, control_inputs=None, input_types=None, original_op=None, op_def=None)</code></h3>
...
<h3 id="get_attr"><code>get_attr(name)</code></h3>
...
<h3 id="run"><code>run(feed_dict=None, session=None)</code></h3>
