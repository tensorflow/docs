...
[`tf.matmul`](../tf/matmul))
or [`tf.Graph.create_op`](../tf/Graph#create_op).
...
#### Returns:
  ...
  A
  [`NodeDef`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/core/framework/node_def.proto)
  protocol buffer.
...
#### Returns:
  ...
  An
  [`OpDef`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/core/framework/op_def.proto)
  protocol buffer.
...
* <b>`feed_dict`</b>: A dictionary that maps `Tensor` objects to feed values.
    See [`tf.Session.run`](../tf/Session#run)
