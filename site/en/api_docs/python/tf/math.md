...
Defined in [`tensorflow/math/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/math/__init__.py).
...
[`softsign(...)`](../tf/math/softsign): Computes softsign: `features / (abs(features) + 1)`.
