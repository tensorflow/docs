...
Defined in [`tensorflow/python/ops/nn.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/python/ops/nn.py).

Neural network support.

See the [Neural Network](../../../api_guides/python/nn) guide.
