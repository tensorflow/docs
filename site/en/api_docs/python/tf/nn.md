...
Defined in [`tensorflow/python/ops/nn.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/ops/nn.py).

Neural network support.

See the <a href="../../../api_guides/python/nn">Neural Network</a> guide.
...
[`atrous_conv2d(...)`](../tf/nn/atrous_conv2d): Atrous convolution (a.k.a.
