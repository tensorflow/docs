...
Defined in [`tensorflow/python/ops/distributions/kullback_leibler.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/ops/distributions/kullback_leibler.py).
