...
Defined in [`tensorflow/python/ops/distributions/identity_bijector.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/ops/distributions/identity_bijector.py).
