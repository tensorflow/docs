...
Defined in [`tensorflow/python/ops/distributions/uniform.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/ops/distributions/uniform.py).
