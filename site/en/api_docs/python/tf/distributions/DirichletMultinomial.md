...
Defined in [`tensorflow/python/ops/distributions/dirichlet_multinomial.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/ops/distributions/dirichlet_multinomial.py).
