...
Defined in [`tensorflow/python/ops/distributions/bernoulli.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/ops/distributions/bernoulli.py).
