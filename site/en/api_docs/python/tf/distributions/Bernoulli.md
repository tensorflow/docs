...
Defined in [`tensorflow/python/ops/distributions/bernoulli.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/ops/distributions/bernoulli.py).
