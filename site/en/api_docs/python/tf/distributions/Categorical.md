...
Defined in [`python/ops/distributions/categorical.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/python/ops/distributions/categorical.py).
