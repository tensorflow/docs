...
<meta itemprop="name" content="tf.raw_ops.Conv3DBackpropFilterV2" />
...
<code>tf.raw_ops.Conv3DBackpropFilterV2(
    input, filter_sizes, out_backprop, strides, padding, data_format='NDHWC',
    dilations=[1, 1, 1, 1, 1], name=None
)
</code></pre>
