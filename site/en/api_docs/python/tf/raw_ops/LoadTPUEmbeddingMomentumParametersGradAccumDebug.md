description: Load Momentum embedding parameters with debug support.

<div itemscope itemtype="http://developers.google.com/ReferenceObject">
<meta itemprop="name" content="tf.raw_ops.LoadTPUEmbeddingMomentumParametersGradAccumDebug" />
...
more details.</p>
<p>`tf.compat.v1.raw_ops.LoadTPUEmbeddingMomentumParametersGradAccumDebug`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.raw_ops.LoadTPUEmbeddingMomentumParametersGradAccumDebug(
