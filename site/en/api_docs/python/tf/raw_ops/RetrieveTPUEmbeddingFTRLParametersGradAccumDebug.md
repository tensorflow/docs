description: Retrieve FTRL embedding parameters with debug support.

<div itemscope itemtype="http://developers.google.com/ReferenceObject">
<meta itemprop="name" content="tf.raw_ops.RetrieveTPUEmbeddingFTRLParametersGradAccumDebug" />
...
more details.</p>
<p>`tf.compat.v1.raw_ops.RetrieveTPUEmbeddingFTRLParametersGradAccumDebug`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.raw_ops.RetrieveTPUEmbeddingFTRLParametersGradAccumDebug(
