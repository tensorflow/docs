...
Defined in [`tensorflow/python/framework/dtypes.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/framework/dtypes.py).
...
* <b>`type_value`</b>: A value that can be converted to a <a href="../../tf/dtypes/DType"><code>tf.DType</code></a> object. This may
    ...
    enum](https://www.github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/core/framework/types.proto),
