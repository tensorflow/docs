...
* <b>`kernel_size`</b>: a tuple or list of N positive integers specifying the spatial
    dimensions of of the filters. Can be a single integer to specify the same
    value for all spatial dimensions.
* <b>`strides`</b>: a tuple or list of N positive integers specifying the strides
