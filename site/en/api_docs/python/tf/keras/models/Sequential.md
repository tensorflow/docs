...
Inherits From: [`Model`](../../../tf/keras/models/Model)
...
Defined in [`tensorflow/python/keras/engine/sequential.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/keras/engine/sequential.py).
...
* <b>`loss`</b>: String (name of objective function) or objective function.
        See <a href="../../../tf/losses"><code>tf.losses</code></a>. If the model has multiple outputs, you can use a
...
* <b>`**kwargs`</b>: These arguments are passed to <a href="../../../tf/InteractiveSession#run"><code>tf.Session.run</code></a>.
