...
Defined in [`tensorflow/python/keras/engine/sequential.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/keras/engine/sequential.py).
