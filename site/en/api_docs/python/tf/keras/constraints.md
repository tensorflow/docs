...
Defined in [`tensorflow/python/keras/constraints/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/keras/constraints/__init__.py).

Keras built-in constraints functions.

## Classes

[`class Constraint`](../../tf/keras/constraints/Constraint)

[`class MaxNorm`](../../tf/keras/constraints/MaxNorm): MaxNorm weight constraint.

[`class MinMaxNorm`](../../tf/keras/constraints/MinMaxNorm): MinMaxNorm weight constraint.
...
[`deserialize(...)`](../../tf/keras/constraints/deserialize)
