...
Defined in [`tensorflow/python/keras/engine/sequential.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/keras/engine/sequential.py).
