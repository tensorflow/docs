...
Defined in [`tensorflow/keras/datasets/reuters/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/keras/datasets/reuters/__init__.py).
