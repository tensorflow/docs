...
Defined in [`tensorflow/python/keras/datasets/reuters/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/keras/datasets/reuters/__init__.py).
