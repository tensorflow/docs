...
Defined in [`tensorflow/python/keras/datasets/imdb/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/keras/datasets/imdb/__init__.py).
