...
Defined in [`tensorflow/python/keras/wrappers/scikit_learn.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/keras/wrappers/scikit_learn.py).
