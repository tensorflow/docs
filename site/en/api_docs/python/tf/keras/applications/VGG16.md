...
Defined in [`tensorflow/python/keras/_impl/keras/applications/vgg16.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/keras/_impl/keras/applications/vgg16.py).
