...
Defined in [`tensorflow/python/keras/applications/vgg16.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/keras/applications/vgg16.py).
