...
Defined in [`tensorflow/python/keras/_impl/keras/applications/nasnet.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/keras/_impl/keras/applications/nasnet.py).
