...
Defined in [`tensorflow/python/keras/applications/resnet50.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/keras/applications/resnet50.py).
