...
Defined in [`tensorflow/python/keras/_impl/keras/applications/resnet50.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/keras/_impl/keras/applications/resnet50.py).
