...
Defined in [`tensorflow/python/keras/applications/nasnet/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/keras/applications/nasnet/__init__.py).
