...
Defined in [`tensorflow/python/keras/preprocessing/image/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/keras/preprocessing/image/__init__.py).
