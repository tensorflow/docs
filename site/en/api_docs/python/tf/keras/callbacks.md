...
Defined in [`tensorflow/python/keras/callbacks/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/keras/callbacks/__init__.py).
