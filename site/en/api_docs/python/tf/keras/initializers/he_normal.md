...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r2.2/tensorflow/python/ops/init_ops_v2.py#L911-L948">
...
<section class="expandable">
  ...
  <p>
<b>Main aliases</b>
<p>`tf.initializers.he_normal`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.keras.initializers.he_normal(
    seed=None
)
</code></pre>
