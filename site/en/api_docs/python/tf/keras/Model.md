...
Defined in [`tensorflow/python/keras/engine/training.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/keras/engine/training.py).
