...
Defined in [`tensorflow/python/keras/metrics/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/keras/metrics/__init__.py).
