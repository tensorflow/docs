...
<td>
  <a target="_blank" href="/api_docs/python/tf/keras/experimental/LinearModel">
  <img src="https://www.tensorflow.org/images/tf_logo_32px.png" />
  TensorFlow 2 version</a>
</td>

<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/python/keras/premade/linear.py#L32-L164">
...
* Class <a href="/api_docs/python/tf/keras/experimental/LinearModel"><code>tf.compat.v1.keras.experimental.LinearModel</code></a>
* Class <a href="/api_docs/python/tf/keras/experimental/LinearModel"><code>tf.compat.v2.keras.experimental.LinearModel</code></a>


<!-- Placeholder for "Used in" -->

This model approximates the following function:
<div> $$y = \beta + \sum_{i=1}^{N} w_{i} * x_{i}$$ </div>
where <div> $$\beta$$ </div> is the bias and <div> $$w_{i}$$ </div> is the weight for each feature.
...
<a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/python/keras/premade/linear.py#L63-L95">View source</a>
