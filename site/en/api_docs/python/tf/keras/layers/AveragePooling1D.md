...
Inherits From: [`AveragePooling1D`](../../../tf/layers/AveragePooling1D), [`Layer`](../../../tf/keras/layers/Layer)
...
Defined in [`tensorflow/python/keras/_impl/keras/layers/pooling.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/keras/_impl/keras/layers/pooling.py).
