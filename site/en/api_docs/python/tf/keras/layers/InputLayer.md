...
Defined in [`tensorflow/python/keras/engine/input_layer.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/keras/engine/input_layer.py).
