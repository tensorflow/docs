...
Defined in [`tensorflow/python/keras/_impl/keras/engine/input_layer.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/python/keras/_impl/keras/engine/input_layer.py).
