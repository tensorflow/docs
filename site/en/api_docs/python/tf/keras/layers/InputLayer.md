...
Defined in [`tensorflow/python/keras/_impl/keras/engine/topology.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/keras/_impl/keras/engine/topology.py).
...
* <b>`input_shape`</b>: Shape tuple, not including the batch axis.
