...
Defined in [`tensorflow/python/keras/_impl/keras/layers/normalization.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/keras/_impl/keras/layers/normalization.py).
