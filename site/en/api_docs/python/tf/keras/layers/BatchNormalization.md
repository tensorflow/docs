...
Defined in [`tensorflow/python/keras/layers/normalization.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.11/tensorflow/python/keras/layers/normalization.py).
