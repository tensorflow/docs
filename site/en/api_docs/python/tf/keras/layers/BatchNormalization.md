...
Defined in [`tensorflow/python/keras/layers/normalization.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/keras/layers/normalization.py).
