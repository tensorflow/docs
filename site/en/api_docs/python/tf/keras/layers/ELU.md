...
Defined in [`tensorflow/python/keras/layers/advanced_activations.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.9/tensorflow/python/keras/layers/advanced_activations.py).
