...
Defined in [`tensorflow/python/keras/layers/embeddings.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/keras/layers/embeddings.py).
