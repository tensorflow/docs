...
Defined in [`tensorflow/python/keras/layers/embeddings.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.9/tensorflow/python/keras/layers/embeddings.py).
