...
Inherits From: [`Conv3D`](../../../tf/layers/Conv3D), [`Layer`](../../../tf/keras/layers/Layer)
...
Defined in [`tensorflow/python/keras/_impl/keras/layers/convolutional.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/keras/_impl/keras/layers/convolutional.py).
