...
Defined in [`tensorflow/python/keras/_impl/keras/engine/base_layer.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/keras/_impl/keras/engine/base_layer.py).
