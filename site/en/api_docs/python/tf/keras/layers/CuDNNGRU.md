...
Defined in [`tensorflow/python/keras/layers/cudnn_recurrent.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/keras/layers/cudnn_recurrent.py).
