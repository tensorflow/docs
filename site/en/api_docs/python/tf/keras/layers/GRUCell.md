...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r2.4/tensorflow/python/keras/layers/recurrent_v2.py#L109-L217">
...
<code>tf.keras.layers.GRUCell(
    ...
    bias_constraint=None, dropout=0.0, recurrent_dropout=0.0, reset_after=(True),
    **kwargs
)
</code></pre>
