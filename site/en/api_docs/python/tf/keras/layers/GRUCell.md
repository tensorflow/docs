...
Defined in [`tensorflow/python/keras/_impl/keras/layers/recurrent.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/keras/_impl/keras/layers/recurrent.py).
