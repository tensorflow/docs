...
Defined in [`tensorflow/python/keras/_impl/keras/layers/advanced_activations.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/python/keras/_impl/keras/layers/advanced_activations.py).
