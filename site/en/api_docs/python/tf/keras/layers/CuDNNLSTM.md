...
Defined in [`tensorflow/python/keras/layers/cudnn_recurrent.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.9/tensorflow/python/keras/layers/cudnn_recurrent.py).
