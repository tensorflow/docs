...
<h3 id="is_abstract"><code>is_abstract(cls)</code></h3>



<h3 id="report_benchmark"><code>report_benchmark(iters=None, cpu_time=None, wall_time=None, throughput=None, extras=None, name=None)</code></h3>
...
<h3 id="run_op_benchmark"><code>run_op_benchmark(sess, op_or_tensor, feed_dict=None, burn_iters=2, min_iters=10, store_trace=False, store_memory_usage=True, name=None, extras=None, mbs=0)</code></h3>
