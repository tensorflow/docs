description: Returns whether TensorFlow was built with GPU (i.e. CUDA or ROCm) support.
...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r2.4/tensorflow/python/platform/test.py#L99-L102">
