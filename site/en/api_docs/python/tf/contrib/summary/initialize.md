...
* <b>`RuntimeError`</b>: If in eager mode, or if the current thread has no
    default <a href="../../../tf/contrib/summary/SummaryWriter"><code>tf.contrib.summary.SummaryWriter</code></a>.
