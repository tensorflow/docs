...
Defined in [`tensorflow/contrib/bayesflow/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/bayesflow/__init__.py).
...
[`halton_sequence`](../../tf/contrib/bayesflow/halton_sequence) module: Support for low discrepancy Halton sequences.

[`hmc`](../../tf/contrib/bayesflow/hmc) module: Hamiltonian Monte Carlo, a gradient-based MCMC algorithm.

[`layers`](../../tf/contrib/bayesflow/layers) module: Probabilistic neural layers.
...
[`optimizers`](../../tf/contrib/bayesflow/optimizers) module: Probabilistic optimizer modules.
