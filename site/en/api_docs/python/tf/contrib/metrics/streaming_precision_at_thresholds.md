...
Defined in [`tensorflow/contrib/metrics/python/ops/metric_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/metrics/python/ops/metric_ops.py).
...
Please switch to tf.metrics.precision_at_thresholds. Note that the order of the labels and predictions arguments has been switched.
