...
Defined in [`tensorflow/contrib/metrics/python/ops/histogram_ops.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/metrics/python/ops/histogram_ops.py).
