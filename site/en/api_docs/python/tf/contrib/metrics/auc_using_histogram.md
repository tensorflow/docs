...
Defined in [`tensorflow/contrib/metrics/python/ops/histogram_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/metrics/python/ops/histogram_ops.py).
