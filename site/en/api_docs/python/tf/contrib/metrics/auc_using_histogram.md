...
Defined in [`tensorflow/contrib/metrics/python/ops/histogram_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/metrics/python/ops/histogram_ops.py).
