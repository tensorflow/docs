...
Defined in [`tensorflow/contrib/metrics/python/metrics/classification.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/metrics/python/metrics/classification.py).
