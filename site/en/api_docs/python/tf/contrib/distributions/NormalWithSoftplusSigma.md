...
<h3 id="__init__"><code>__init__(mu, sigma, validate_args=False, allow_nan_stats=True, name='NormalWithSoftplusSigma')</code></h3>
...
Defined in [`tensorflow/contrib/distributions/python/ops/normal.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/normal.py).
