...
<h3 id="__init__"><code>__init__(p=None, dtype=tf.int32, validate_args=False, allow_nan_stats=True, name='BernoulliWithSigmoidP')</code></h3>
...
Defined in [`tensorflow/contrib/distributions/python/ops/bernoulli.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/bernoulli.py).
