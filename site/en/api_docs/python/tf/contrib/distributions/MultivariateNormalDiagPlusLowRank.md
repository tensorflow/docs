...
Defined in [`tensorflow/contrib/distributions/python/ops/mvn_diag_plus_low_rank.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/distributions/python/ops/mvn_diag_plus_low_rank.py).
