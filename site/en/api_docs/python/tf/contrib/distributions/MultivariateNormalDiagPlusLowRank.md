...
Defined in [`contrib/distributions/python/ops/mvn_diag_plus_low_rank.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/distributions/python/ops/mvn_diag_plus_low_rank.py).
