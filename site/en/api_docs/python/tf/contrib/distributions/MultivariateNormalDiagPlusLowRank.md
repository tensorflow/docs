...
### `class tf.contrib.distributions.MultivariateNormalDiagPlusLowRank`



Defined in [`tensorflow/contrib/distributions/python/ops/mvn_diag_plus_low_rank.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/distributions/python/ops/mvn_diag_plus_low_rank.py).
...
<h3 id="det_covariance"><code>det_covariance</code></h3>

``` python
det_covariance(name='det_covariance')
```
...
<h3 id="log_det_covariance"><code>log_det_covariance</code></h3>

``` python
log_det_covariance(name='log_det_covariance')
```
