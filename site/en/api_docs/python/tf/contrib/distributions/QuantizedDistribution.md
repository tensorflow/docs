...
Defined in [`tensorflow/contrib/distributions/python/ops/quantized_distribution.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/python/ops/quantized_distribution.py).
