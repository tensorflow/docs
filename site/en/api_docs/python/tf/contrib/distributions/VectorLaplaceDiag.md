...
### `class tf.contrib.distributions.VectorLaplaceDiag`



Defined in [`tensorflow/contrib/distributions/python/ops/vector_laplace_diag.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/python/ops/vector_laplace_diag.py).
