...
Defined in [`contrib/distributions/python/ops/vector_laplace_diag.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/distributions/python/ops/vector_laplace_diag.py).
