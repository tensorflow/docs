...
Defined in [`tensorflow/contrib/distributions/python/ops/vector_exponential_diag.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/distributions/python/ops/vector_exponential_diag.py).
