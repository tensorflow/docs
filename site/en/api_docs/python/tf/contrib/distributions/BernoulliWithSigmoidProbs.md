...
### `class tf.contrib.distributions.BernoulliWithSigmoidProbs`



Defined in [`tensorflow/contrib/distributions/python/ops/bernoulli.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/distributions/python/ops/bernoulli.py).
