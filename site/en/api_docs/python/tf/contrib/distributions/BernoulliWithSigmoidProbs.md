...
Defined in [`tensorflow/python/ops/distributions/bernoulli.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/python/ops/distributions/bernoulli.py).
