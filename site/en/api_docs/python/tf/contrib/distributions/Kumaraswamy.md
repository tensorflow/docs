...
Defined in [`tensorflow/contrib/distributions/python/ops/kumaraswamy.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/distributions/python/ops/kumaraswamy.py).
