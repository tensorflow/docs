...
Defined in [`tensorflow/contrib/distributions/python/ops/geometric.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/python/ops/geometric.py).
