...
Defined in [`tensorflow/contrib/distributions/python/ops/geometric.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/distributions/python/ops/geometric.py).
