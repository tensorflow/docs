...
### `class tf.contrib.distributions.Geometric`



Defined in [`tensorflow/contrib/distributions/python/ops/geometric.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/distributions/python/ops/geometric.py).
