...
### `class tf.contrib.distributions.OneHotCategorical`



Defined in [`tensorflow/contrib/distributions/python/ops/onehot_categorical.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/python/ops/onehot_categorical.py).
