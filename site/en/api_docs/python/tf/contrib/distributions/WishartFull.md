...
Defined in [`tensorflow/contrib/distributions/python/ops/wishart.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/distributions/python/ops/wishart.py).
