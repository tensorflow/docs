...
Defined in [`tensorflow/contrib/distributions/python/ops/poisson.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/distributions/python/ops/poisson.py).
