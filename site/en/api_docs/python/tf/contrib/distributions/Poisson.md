...
Defined in [`tensorflow/contrib/distributions/python/ops/poisson.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/distributions/python/ops/poisson.py).
