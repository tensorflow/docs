...
Defined in [`tensorflow/python/ops/distributions/laplace.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/ops/distributions/laplace.py).
