...
Defined in [`tensorflow/python/ops/distributions/laplace.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/ops/distributions/laplace.py).
