...
<h3 id="__init__"><code>__init__(loc, scale, validate_args=False, allow_nan_stats=True, name='LaplaceWithSoftplusScale')</code></h3>
...
Defined in [`tensorflow/contrib/distributions/python/ops/laplace.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/laplace.py).
