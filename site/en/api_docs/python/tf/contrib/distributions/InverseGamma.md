...
Defined in [`tensorflow/contrib/distributions/python/ops/inverse_gamma.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/distributions/python/ops/inverse_gamma.py).
...
values. See note in <a href="../../../tf/random/gamma"><code>tf.random_gamma</code></a> docstring.
