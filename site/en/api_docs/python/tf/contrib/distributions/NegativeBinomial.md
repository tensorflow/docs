...
Defined in [`tensorflow/contrib/distributions/python/ops/negative_binomial.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/distributions/python/ops/negative_binomial.py).
