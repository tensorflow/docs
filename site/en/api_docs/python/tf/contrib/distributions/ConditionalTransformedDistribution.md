...
### `class tf.contrib.distributions.ConditionalTransformedDistribution`



Defined in [`tensorflow/contrib/distributions/python/ops/conditional_transformed_distribution.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/python/ops/conditional_transformed_distribution.py).
