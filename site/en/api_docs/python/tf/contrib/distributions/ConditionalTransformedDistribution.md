...
Defined in [`tensorflow/contrib/distributions/python/ops/conditional_transformed_distribution.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/distributions/python/ops/conditional_transformed_distribution.py).
