...
Defined in [`tensorflow/contrib/distributions/python/ops/conditional_transformed_distribution.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/distributions/python/ops/conditional_transformed_distribution.py).
