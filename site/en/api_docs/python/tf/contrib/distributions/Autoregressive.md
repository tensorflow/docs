...
Defined in [`tensorflow/contrib/distributions/python/ops/autoregressive.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.9/tensorflow/contrib/distributions/python/ops/autoregressive.py).
