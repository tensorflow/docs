...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/autoregressive.py#L29-L222">
...
constructs a <a href="/probability/api_docs/python/tfp/distributions/Distribution"><code>tfp.distributions.Distribution</code></a>-like instance, and `x0` is a
...
<a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/autoregressive.py#L112-L178">View source</a>
...
* <b>`distribution_fn`</b>: Python `callable` which constructs a
  <a href="/probability/api_docs/python/tfp/distributions/Distribution"><code>tfp.distributions.Distribution</code></a>-like instance from a `Tensor` (e.g.,
