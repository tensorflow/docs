...
Defined in [`tensorflow/contrib/distributions/python/ops/dirichlet_multinomial.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/distributions/python/ops/dirichlet_multinomial.py).
