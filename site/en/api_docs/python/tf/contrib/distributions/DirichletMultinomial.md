...
<h3 id="__init__"><code>__init__(n, alpha, validate_args=False, allow_nan_stats=True, name='DirichletMultinomial')</code></h3>
...
Defined in [`tensorflow/contrib/distributions/python/ops/dirichlet_multinomial.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/dirichlet_multinomial.py).
