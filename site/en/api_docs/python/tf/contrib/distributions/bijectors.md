...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/python/ops/bijectors/__init__.py).
...
[`class Bijector`](../../../tf/contrib/distributions/bijectors/Bijector): Interface for invertible transformations of a `Distribution` sample.
