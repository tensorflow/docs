...
### `class tf.contrib.distributions.InverseGammaWithSoftplusConcentrationRate`



Defined in [`tensorflow/contrib/distributions/python/ops/inverse_gamma.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/distributions/python/ops/inverse_gamma.py).
