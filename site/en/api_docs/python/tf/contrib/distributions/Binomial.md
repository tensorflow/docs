...
Defined in [`tensorflow/contrib/distributions/python/ops/binomial.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/distributions/python/ops/binomial.py).
