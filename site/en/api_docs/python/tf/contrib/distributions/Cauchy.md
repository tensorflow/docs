...
Defined in [`tensorflow/contrib/distributions/python/ops/cauchy.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.9/tensorflow/contrib/distributions/python/ops/cauchy.py).
