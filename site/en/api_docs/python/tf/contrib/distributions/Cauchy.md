...
Defined in [`tensorflow/contrib/distributions/python/ops/cauchy.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/distributions/python/ops/cauchy.py).
