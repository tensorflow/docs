...
Defined in [`tensorflow/python/ops/distributions/student_t.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/ops/distributions/student_t.py).
