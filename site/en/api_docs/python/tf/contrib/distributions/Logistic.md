...
### `class tf.contrib.distributions.Logistic`



Defined in [`tensorflow/contrib/distributions/python/ops/logistic.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/python/ops/logistic.py).
