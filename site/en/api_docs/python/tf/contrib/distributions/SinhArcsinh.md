...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/sinh_arcsinh.py#L35-L226">
...
<a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/sinh_arcsinh.py#L98-L206">View source</a>
...
* <b>`distribution`</b>: `tf.Distribution`-like instance. Distribution that is
  ...
  Default is <a href="/probability/api_docs/python/tfp/distributions/Normal"><code>tfp.distributions.Normal(0., 1.)</code></a>.
