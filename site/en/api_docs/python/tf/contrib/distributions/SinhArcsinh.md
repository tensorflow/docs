...
Defined in [`contrib/distributions/python/ops/sinh_arcsinh.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/distributions/python/ops/sinh_arcsinh.py).
