...
<h3 id="a_b_sum"><code>a_b_sum</code></h3>
...
<h3 id="__init__"><code>__init__(a, b, validate_args=False, allow_nan_stats=True, name='BetaWithSoftplusAB')</code></h3>
...
Defined in [`tensorflow/contrib/distributions/python/ops/beta.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/beta.py).
