...
Defined in [`tensorflow/python/ops/distributions/beta.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/ops/distributions/beta.py).
