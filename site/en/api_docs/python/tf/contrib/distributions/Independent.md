...
Defined in [`tensorflow/contrib/distributions/python/ops/independent.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/distributions/python/ops/independent.py).
