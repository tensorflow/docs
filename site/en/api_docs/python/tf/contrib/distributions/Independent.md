...
Defined in [`tensorflow/contrib/distributions/python/ops/independent.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/distributions/python/ops/independent.py).
