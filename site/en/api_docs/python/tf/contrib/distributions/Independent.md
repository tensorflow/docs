...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/independent.py#L35-L273">
...
<a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/independent.py#L99-L156">View source</a>
...
* <b>`reinterpreted_batch_ndims`</b>: Scalar, integer number of rightmost batch dims
  ...
  (analogous to <a href="../../../tf/layers/flatten"><code>tf.compat.v1.layers.flatten</code></a>).
