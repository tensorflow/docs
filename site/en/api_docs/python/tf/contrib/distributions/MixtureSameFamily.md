...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/mixture_same_family.py#L35-L335">
...
<a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/mixture_same_family.py#L101-L222">View source</a>
...
* <b>`mixture_distribution`</b>: <a href="/probability/api_docs/python/tfp/distributions/Categorical"><code>tfp.distributions.Categorical</code></a>-like instance.
  Manages the probability of selecting components. The number of
  categories must match the rightmost batch dimension of the
  `components_distribution`. Must have either scalar `batch_shape` or
  `batch_shape` matching `components_distribution.batch_shape[:-1]`.
* <b>`components_distribution`</b>: <a href="/probability/api_docs/python/tfp/distributions/Distribution"><code>tfp.distributions.Distribution</code></a>-like instance.
