...
Defined in [`contrib/distributions/python/ops/bijectors/transform_diagonal.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/distributions/python/ops/bijectors/transform_diagonal.py).
