...
### `class tf.contrib.distributions.bijectors.Invert`



Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/invert_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/python/ops/bijectors/invert_impl.py).
