...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/masked_autoregressive.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/distributions/python/ops/bijectors/masked_autoregressive.py).
...
* <b>`shift`</b>: `Float`-like `Tensor` of shift terms (the "mu" in [2]).
* <b>`log_scale`</b>: `Float`-like `Tensor` of log(scale) terms (the "alpha" in [2]).
