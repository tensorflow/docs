...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/bijectors/permute.py#L39-L147">
...
Warning: <a href="../../../../tf/estimator"><code>tf.estimator</code></a> may repeatedly build the graph thus
`Permute(np.random.permutation(event_size)).astype("int32"))` is not a
reliable parameterization (nor would it be even if using <a href="../../../../tf/constant"><code>tf.constant</code></a>). A
safe alternative is to use <a href="../../../../tf/get_variable"><code>tf.compat.v1.get_variable</code></a> to achieve "init once"
behavior,
i.e.,
...
<a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/bijectors/permute.py#L79-L127">View source</a>
