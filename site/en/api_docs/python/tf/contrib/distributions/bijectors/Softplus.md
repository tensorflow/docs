...
### `class tf.contrib.distributions.bijectors.Softplus`



Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/softplus_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/python/ops/bijectors/softplus_impl.py).
