...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/softplus.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/distributions/python/ops/bijectors/softplus.py).
