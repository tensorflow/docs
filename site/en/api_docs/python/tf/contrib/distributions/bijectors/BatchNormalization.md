...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/bijectors/batch_normalization.py#L82-L283">
...
<a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/bijectors/batch_normalization.py#L139-L183">View source</a>
...
* <b>`batchnorm_layer`</b>: <a href="../../../../tf/layers/BatchNormalization"><code>tf.compat.v1.layers.BatchNormalization</code></a> layer object. If
  `None`, defaults to
...
* <b>`ValueError`</b>: If bn_layer is not an instance of
  <a href="../../../../tf/layers/BatchNormalization"><code>tf.compat.v1.layers.BatchNormalization</code></a>, or if it is specified with
  `renorm=True`
