...
Defined in [`contrib/distributions/python/ops/bijectors/batch_normalization.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/distributions/python/ops/bijectors/batch_normalization.py).
