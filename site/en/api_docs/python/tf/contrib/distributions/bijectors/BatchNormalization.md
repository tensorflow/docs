...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/batch_normalization.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/distributions/python/ops/bijectors/batch_normalization.py).
