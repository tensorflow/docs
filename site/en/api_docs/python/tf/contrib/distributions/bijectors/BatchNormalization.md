...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/batch_normalization.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/distributions/python/ops/bijectors/batch_normalization.py).
