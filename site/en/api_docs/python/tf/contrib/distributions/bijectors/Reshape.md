...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/bijectors/reshape.py#L65-L343">
...
The semantics generally follow that of <a href="../../../../tf/reshape"><code>tf.reshape()</code></a>, with
a few differences:
...
<a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/bijectors/reshape.py#L108-L162">View source</a>
