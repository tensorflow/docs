...
Defined in [`tensorflow/python/ops/distributions/bijector_impl.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/ops/distributions/bijector_impl.py).
