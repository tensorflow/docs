...
Defined in [`tensorflow/python/ops/distributions/bijector_impl.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/ops/distributions/bijector_impl.py).
