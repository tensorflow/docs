...
Defined in [`contrib/distributions/python/ops/bijectors/softmax_centered.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/distributions/python/ops/bijectors/softmax_centered.py).
