...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/softmax_centered.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/distributions/python/ops/bijectors/softmax_centered.py).
