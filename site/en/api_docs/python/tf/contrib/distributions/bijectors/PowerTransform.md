...
### `class tf.contrib.distributions.bijectors.PowerTransform`



Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/power_transform_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/python/ops/bijectors/power_transform_impl.py).
