...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/power_transform.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/distributions/python/ops/bijectors/power_transform.py).
