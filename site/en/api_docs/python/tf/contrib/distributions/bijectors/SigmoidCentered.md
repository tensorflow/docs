...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/sigmoid_centered.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/distributions/python/ops/bijectors/sigmoid_centered.py).
