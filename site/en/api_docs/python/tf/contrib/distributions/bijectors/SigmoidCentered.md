...
### `class tf.contrib.distributions.bijectors.SigmoidCentered`



Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/sigmoid_centered_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/python/ops/bijectors/sigmoid_centered_impl.py).
