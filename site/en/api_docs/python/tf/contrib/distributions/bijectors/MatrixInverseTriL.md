...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/matrix_inverse_tril.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/distributions/python/ops/bijectors/matrix_inverse_tril.py).
