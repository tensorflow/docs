...
Defined in [`contrib/distributions/python/ops/bijectors/matrix_inverse_tril.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/distributions/python/ops/bijectors/matrix_inverse_tril.py).
