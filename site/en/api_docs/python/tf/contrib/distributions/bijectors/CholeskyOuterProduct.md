...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/cholesky_outer_product_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/python/ops/bijectors/cholesky_outer_product_impl.py).
