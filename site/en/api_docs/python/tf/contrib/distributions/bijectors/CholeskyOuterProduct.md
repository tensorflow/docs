...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/cholesky_outer_product.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/distributions/python/ops/bijectors/cholesky_outer_product.py).
