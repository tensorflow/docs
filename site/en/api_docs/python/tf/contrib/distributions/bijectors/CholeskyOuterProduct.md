...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/cholesky_outer_product.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/distributions/python/ops/bijectors/cholesky_outer_product.py).
