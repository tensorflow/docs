...
Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/exp.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/distributions/python/ops/bijectors/exp.py).
