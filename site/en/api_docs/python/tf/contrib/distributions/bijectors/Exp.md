...
### `class tf.contrib.distributions.bijectors.Exp`



Defined in [`tensorflow/contrib/distributions/python/ops/bijectors/exp_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/python/ops/bijectors/exp_impl.py).
