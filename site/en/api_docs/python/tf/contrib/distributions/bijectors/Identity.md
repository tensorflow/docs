...
Defined in [`python/ops/distributions/identity_bijector.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/python/ops/distributions/identity_bijector.py).
