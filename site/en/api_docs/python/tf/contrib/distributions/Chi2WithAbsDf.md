...
Defined in [`tensorflow/contrib/distributions/python/ops/chi2.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/distributions/python/ops/chi2.py).
