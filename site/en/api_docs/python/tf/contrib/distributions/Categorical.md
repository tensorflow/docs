...
Defined in [`tensorflow/python/ops/distributions/categorical.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/python/ops/distributions/categorical.py).
