...
Defined in [`tensorflow/contrib/distributions/python/ops/half_normal.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/distributions/python/ops/half_normal.py).
