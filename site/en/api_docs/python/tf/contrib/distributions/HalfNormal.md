...
Defined in [`tensorflow/contrib/distributions/python/ops/half_normal.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/distributions/python/ops/half_normal.py).
