...
<h3 id="__init__"><code>__init__(dtype, is_continuous, is_reparameterized, validate_args, allow_nan_stats, parameters=None, graph_parents=None, name=None)</code></h3>
...
Defined in [`tensorflow/contrib/distributions/python/ops/distribution.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/distribution.py).
