...
<h3 id="__init__"><code>__init__(cat, components, validate_args=False, allow_nan_stats=True, name='Mixture')</code></h3>
...
<h3 id="entropy_lower_bound"><code>entropy_lower_bound(name='entropy_lower_bound')</code></h3>
