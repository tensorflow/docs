...
### `class tf.contrib.distributions.ConditionalDistribution`



Defined in [`tensorflow/contrib/distributions/python/ops/conditional_distribution.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/distributions/python/ops/conditional_distribution.py).
