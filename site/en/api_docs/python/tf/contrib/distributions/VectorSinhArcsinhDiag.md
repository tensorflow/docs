...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/vector_sinh_arcsinh_diag.py#L35-L274">
...
<a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/vector_sinh_arcsinh_diag.py#L99-L254">View source</a>
...
* <b>`distribution`</b>: `tf.Distribution`-like instance. Distribution from which `k`
  ...
  <a href="/probability/api_docs/python/tfp/distributions/Normal"><code>tfp.distributions.Normal(loc=0., scale=1.)</code></a>.
