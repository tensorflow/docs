...
Defined in [`tensorflow/contrib/distributions/python/ops/vector_sinh_arcsinh_diag.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/distributions/python/ops/vector_sinh_arcsinh_diag.py).
