...
<h3 id="__init__"><code>__init__(df, mu, sigma, validate_args=False, allow_nan_stats=True, name='StudentTWithAbsDfSoftplusSigma')</code></h3>
...
Defined in [`tensorflow/contrib/distributions/python/ops/student_t.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/student_t.py).
