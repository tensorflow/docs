...
<h3 id="__init__"><code>__init__(lam, validate_args=False, allow_nan_stats=True, name='ExponentialWithSoftplusLam')</code></h3>
...
Defined in [`tensorflow/contrib/distributions/python/ops/exponential.py`](https://www.tensorflow.org/code/tensorflow/contrib/distributions/python/ops/exponential.py).
