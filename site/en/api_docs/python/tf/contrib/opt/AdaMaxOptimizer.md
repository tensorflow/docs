...
Defined in [`tensorflow/contrib/opt/python/training/adamax.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/opt/python/training/adamax.py).
