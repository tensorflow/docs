...
Defined in [`tensorflow/contrib/opt/python/training/agn_optimizer.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/opt/python/training/agn_optimizer.py).
