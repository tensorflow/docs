...
Defined in [`tensorflow/contrib/opt/python/training/addsign.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/opt/python/training/addsign.py).
