...
<h3 id="__init__"><code>__init__(loss, var_list=None, equalities=None, inequalities=None, **optimizer_kwargs)</code></h3>
...
<h3 id="minimize"><code>minimize(session=None, feed_dict=None, fetches=None, step_callback=None, loss_callback=None)</code></h3>
