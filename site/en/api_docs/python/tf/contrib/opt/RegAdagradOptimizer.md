...
Defined in [`tensorflow/contrib/opt/python/training/reg_adagrad_optimizer.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/opt/python/training/reg_adagrad_optimizer.py).
