...
Defined in [`tensorflow/contrib/opt/python/training/moving_average_optimizer.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/opt/python/training/moving_average_optimizer.py).
