...
<h3 id="__init__"><code>__init__(opt, average_decay=0.9999, num_updates=None, sequential_update=True)</code></h3>
...
<h3 id="swapping_saver"><code>swapping_saver(var_list=None, name='swapping_saver', **kwargs)</code></h3>
