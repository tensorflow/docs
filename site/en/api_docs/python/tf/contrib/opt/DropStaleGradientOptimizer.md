...
Defined in [`tensorflow/contrib/opt/python/training/drop_stale_gradient_optimizer.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/opt/python/training/drop_stale_gradient_optimizer.py).
