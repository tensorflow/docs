...
Defined in [`tensorflow/contrib/opt/python/training/powersign.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/opt/python/training/powersign.py).
