...
Defined in [`tensorflow/contrib/opt/python/training/powersign.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/opt/python/training/powersign.py).
...
* <b>`sign_decay_fn`</b>: decay function applied to the sign(g*m) quantity.
