...
Defined in [`tensorflow/contrib/opt/python/training/lazy_adam_optimizer.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/opt/python/training/lazy_adam_optimizer.py).
