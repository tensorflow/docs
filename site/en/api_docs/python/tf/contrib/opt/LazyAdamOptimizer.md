...
Defined in [`tensorflow/contrib/opt/python/training/lazy_adam_optimizer.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/opt/python/training/lazy_adam_optimizer.py).
