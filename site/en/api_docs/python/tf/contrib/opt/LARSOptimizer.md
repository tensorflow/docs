...
Defined in [`tensorflow/contrib/opt/python/training/lars_optimizer.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/opt/python/training/lars_optimizer.py).
