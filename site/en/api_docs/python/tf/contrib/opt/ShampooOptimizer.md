...
Defined in [`tensorflow/contrib/opt/python/training/shampoo.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/opt/python/training/shampoo.py).
