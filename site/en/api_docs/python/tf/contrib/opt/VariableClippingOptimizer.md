...
Defined in [`tensorflow/contrib/opt/python/training/variable_clipping_optimizer.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/opt/python/training/variable_clipping_optimizer.py).
