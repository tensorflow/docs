...
Defined in [`contrib/opt/python/training/adam_gs_optimizer.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/opt/python/training/adam_gs_optimizer.py).
