...
Defined in [`tensorflow/contrib/opt/python/training/adam_gs_optimizer.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/opt/python/training/adam_gs_optimizer.py).
