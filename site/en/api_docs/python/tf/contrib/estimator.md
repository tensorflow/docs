...
Defined in [`tensorflow/contrib/estimator/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/estimator/__init__.py).
...
[`clip_gradients_by_norm(...)`](../../tf/contrib/estimator/clip_gradients_by_norm): Returns an optimizer which clips gradients before appliying them.
...
[`replicate_model_fn(...)`](../../tf/contrib/estimator/replicate_model_fn): Replicate `Estimator.model_fn` over GPUs within a single host.
