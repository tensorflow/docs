...
Defined in [`tensorflow/contrib/learn/python/learn/estimators/dnn.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/learn/python/learn/estimators/dnn.py).
