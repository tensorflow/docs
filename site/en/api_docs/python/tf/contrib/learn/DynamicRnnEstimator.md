...
Defined in [`tensorflow/contrib/learn/python/learn/estimators/dynamic_rnn_estimator.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/learn/python/learn/estimators/dynamic_rnn_estimator.py).
