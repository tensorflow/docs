...
Defined in [`tensorflow/contrib/learn/python/learn/estimators/dynamic_rnn_estimator.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/learn/python/learn/estimators/dynamic_rnn_estimator.py).
...
* <b>`cell_type`</b>: A subclass of `RNNCell`, an instance of an `RNNCell` or one of
...
* <b>`ValueError`</b>: Both or neither of the following are true: (a) `num_units` is
