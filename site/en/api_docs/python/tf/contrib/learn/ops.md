...
Defined in [`tensorflow/contrib/learn/python/learn/ops/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/learn/python/learn/ops/__init__.py).
