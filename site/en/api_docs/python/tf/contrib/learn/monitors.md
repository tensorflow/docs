...
Defined in [`tensorflow/contrib/learn/python/learn/monitors.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/learn/python/learn/monitors.py).
