...
Defined in [`tensorflow/contrib/learn/python/learn/learn_io/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.9/tensorflow/contrib/learn/python/learn/learn_io/__init__.py).
