...
Defined in [`tensorflow/contrib/learn/python/learn/utils/saved_model_export_utils.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/learn/python/learn/utils/saved_model_export_utils.py).
