...
### `class tf.contrib.learn.PredictionKey`



Defined in [`tensorflow/contrib/learn/python/learn/estimators/prediction_key.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/learn/python/learn/estimators/prediction_key.py).
