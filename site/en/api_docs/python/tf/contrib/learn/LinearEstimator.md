...
### `class tf.contrib.learn.LinearEstimator`



Defined in [`tensorflow/contrib/learn/python/learn/estimators/linear.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/learn/python/learn/estimators/linear.py).
