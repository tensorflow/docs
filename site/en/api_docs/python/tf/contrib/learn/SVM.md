...
Defined in [`tensorflow/contrib/learn/python/learn/estimators/svm.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/learn/python/learn/estimators/svm.py).
