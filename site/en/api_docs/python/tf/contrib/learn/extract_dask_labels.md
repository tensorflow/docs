...
Defined in [`tensorflow/contrib/learn/python/learn/learn_io/dask_io.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/learn/python/learn/learn_io/dask_io.py).
