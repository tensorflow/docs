...
### `class tf.contrib.learn.DNNEstimator`



Defined in [`tensorflow/contrib/learn/python/learn/estimators/dnn.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/learn/python/learn/estimators/dnn.py).
