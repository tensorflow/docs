...
Defined in [`tensorflow/contrib/learn/python/learn/graph_actions.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/learn/python/learn/graph_actions.py).
...
* <b>`ValueError`</b>: If `output_dir`, `train_op`, `loss_op`, or `global_step_tensor`
    is not provided. See <a href="../../../tf/contrib/framework/get_global_step"><code>tf.contrib.framework.get_global_step</code></a> for how we
