...
<h3 id="__init__"><code>__init__(metric_fn, prediction_key=None, label_key=None, weight_key=None)</code></h3>
...
* <b>`metric_fn`</b>: A function to use as a metric. Must accept `predictions`,
...
<h3 id="create_metric_ops"><code>create_metric_ops(inputs, labels, predictions)</code></h3>
