...
Defined in [`tensorflow/contrib/learn/python/learn/metric_spec.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/learn/python/learn/metric_spec.py).
