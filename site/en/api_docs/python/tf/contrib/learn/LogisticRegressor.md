...
Defined in [`tensorflow/contrib/learn/python/learn/estimators/logistic_regressor.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/learn/python/learn/estimators/logistic_regressor.py).
