...
Defined in [`tensorflow/contrib/learn/python/learn/trainable.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/learn/python/learn/trainable.py).
