...
Defined in [`tensorflow/contrib/learn/python/learn/preprocessing/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.9/tensorflow/contrib/learn/python/learn/preprocessing/__init__.py).
