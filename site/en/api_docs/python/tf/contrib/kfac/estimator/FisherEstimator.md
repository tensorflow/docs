...
Defined in [`tensorflow/contrib/kfac/python/ops/estimator.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/kfac/python/ops/estimator.py).
...
* <b>`damping_fn`</b>: Function, accepts no arguments and returns damping value.
