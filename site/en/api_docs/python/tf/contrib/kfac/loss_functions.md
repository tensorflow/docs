...
Defined in [`tensorflow/contrib/kfac/python/ops/loss_functions_lib.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/kfac/python/ops/loss_functions_lib.py).
