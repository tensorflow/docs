...
Defined in [`tensorflow/contrib/kfac/python/ops/layer_collection.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/kfac/python/ops/layer_collection.py).
...
* <b>`reuse`</b>: (OPTIONAL) bool or str.  If True, reuse an existing FisherBlock.
...
* <b>`approx`</b>: str. One of "kron" or "diagonal".
* <b>`reuse`</b>: bool or str.  If True, reuse an existing FisherBlock. If False,
...
* <b>`approx`</b>: str. One of "kron_indep", "kron_series_1", or "kron_series_2".
...
* <b>`batch_size`</b>: 0-D Tensor. Size of the minibatch.
* <b>`approx`</b>: str. One of "full" or "diagonal".
* <b>`reuse`</b>: bool or str.  If True, reuse an existing FisherBlock. If False,
    create a new FisherBlock.  If "VARIABLE_SCOPE", use
    tf.get_variable_scope().reuse.
