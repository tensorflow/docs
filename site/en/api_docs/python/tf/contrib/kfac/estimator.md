...
Defined in [`tensorflow/contrib/kfac/python/ops/estimator_lib.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/kfac/python/ops/estimator_lib.py).
