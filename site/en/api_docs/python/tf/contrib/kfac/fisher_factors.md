...
Defined in [`tensorflow/contrib/kfac/python/ops/fisher_factors_lib.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/kfac/python/ops/fisher_factors_lib.py).
