...
Defined in [`tensorflow/contrib/kfac/python/ops/fisher_factors_lib.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/kfac/python/ops/fisher_factors_lib.py).
...
[`class InverseProvidingFactor`](../../../tf/contrib/kfac/fisher_factors/InverseProvidingFactor): Base class for FisherFactors that maintain inverses explicitly.
...
[`maybe_colocate_with(...)`](../../../tf/contrib/kfac/fisher_factors/maybe_colocate_with): Context to colocate with `op` if `COLOCATE_COV_OPS_WITH_INPUTS`.
