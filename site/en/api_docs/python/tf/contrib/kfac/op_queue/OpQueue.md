...
Defined in [`tensorflow/contrib/kfac/python/ops/op_queue.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/kfac/python/ops/op_queue.py).
