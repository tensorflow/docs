...
Defined in [`tensorflow/contrib/training/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/training/__init__.py).

Training and input utilities.

See [Training (contrib)](../../../../api_guides/python/contrib.training) guide.


## Classes

[`class FailureTolerator`](../../tf/contrib/training/FailureTolerator): Helper for tolerating certain exceptions.
