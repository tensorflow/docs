...
Defined in [`tensorflow/contrib/cluster_resolver/python/training/gce_cluster_resolver.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/cluster_resolver/python/training/gce_cluster_resolver.py).
