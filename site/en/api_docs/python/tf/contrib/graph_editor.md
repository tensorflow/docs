...
TensorFlow Graph Editor. See the [Graph Editor (contrib)](../../../../api_guides/python/contrib.graph_editor) guide.

## Members

[`class ControlOutputs`](../../tf/contrib/graph_editor/ControlOutputs): The control outputs topology.

[`class OpMatcher`](../../tf/contrib/graph_editor/OpMatcher): Graph match class.
...
[`add_control_inputs(...)`](../../tf/contrib/graph_editor/add_control_inputs): Add the control inputs cops to co.
...
[`match`](../../tf/contrib/graph_editor/match) module: Simple graph matching functions.

[`op_type(...)`](../../tf/contrib/graph_editor/op_type): Check if an op is of the given type.
...
[`reroute_inputs(...)`](../../tf/contrib/graph_editor/reroute_inputs): Re-route all the inputs of sgv0 to sgv1 (see reroute_inputs).

[`reroute_ios(...)`](../../tf/contrib/graph_editor/reroute_ios): Re-route the inputs and outputs of sgv0 to sgv1 (see _reroute).

[`reroute_outputs(...)`](../../tf/contrib/graph_editor/reroute_outputs): Re-route all the outputs of sgv0 to sgv1 (see _reroute_outputs).
...
[`swap_ios(...)`](../../tf/contrib/graph_editor/swap_ios): Swap the inputs and outputs of sgv1 to sgv0 (see _reroute).

[`swap_outputs(...)`](../../tf/contrib/graph_editor/swap_outputs): Swap all the outputs of sgv0 and sgv1 (see _reroute_outputs).
...
[`util`](../../tf/contrib/graph_editor/util) module: Utility funtions for the graph_editor.
