...
Defined in [`tensorflow/contrib/kernel_methods/__init__.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/kernel_methods/__init__.py).
