...
Defined in [`tensorflow/contrib/kernel_methods/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/kernel_methods/__init__.py).
