...
Defined in [`tensorflow/contrib/gan/python/eval/python/sliced_wasserstein_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/gan/python/eval/python/sliced_wasserstein_impl.py).
