...
Defined in [`tensorflow/contrib/gan/python/eval/python/sliced_wasserstein_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/gan/python/eval/python/sliced_wasserstein_impl.py).
...
* <b>`resolution_min`</b>: (int) Minimum resolution for the Laplacion pyramid.
