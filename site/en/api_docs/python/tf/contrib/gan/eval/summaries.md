...
Defined in [`tensorflow/contrib/gan/python/eval/python/summaries.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/gan/python/eval/python/summaries.py).
