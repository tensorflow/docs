...
Defined in [`tensorflow/contrib/gan/python/eval/python/classifier_metrics.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/gan/python/eval/python/classifier_metrics.py).
...
[`classifier_score_from_logits(...)`](../../../../tf/contrib/gan/eval/classifier_score_from_logits): Classifier score for evaluating a conditional generative model.
