...
Defined in [`tensorflow/contrib/gan/python/eval/python/eval_utils.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/gan/python/eval/python/eval_utils.py).
