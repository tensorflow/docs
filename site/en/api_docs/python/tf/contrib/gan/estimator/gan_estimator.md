...
Defined in [`tensorflow/contrib/gan/python/estimator/python/gan_estimator.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/gan/python/estimator/python/gan_estimator.py).
