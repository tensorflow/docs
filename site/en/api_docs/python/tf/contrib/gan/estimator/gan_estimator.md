...
Defined in [`tensorflow/contrib/gan/python/estimator/python/gan_estimator.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/gan/python/estimator/python/gan_estimator.py).
