...
Defined in [`tensorflow/contrib/gan/python/estimator/python/head.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/gan/python/estimator/python/head.py).
