...
Defined in [`tensorflow/contrib/gan/python/estimator/python/head.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/gan/python/estimator/python/head.py).
