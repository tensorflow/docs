...
Defined in [`tensorflow/contrib/gan/python/features/python/random_tensor_pool_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/gan/python/features/python/random_tensor_pool_impl.py).
