...
Defined in [`tensorflow/contrib/gan/python/features/python/conditioning_utils_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/gan/python/features/python/conditioning_utils_impl.py).
