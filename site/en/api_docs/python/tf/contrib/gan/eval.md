...
Defined in [`tensorflow/contrib/gan/python/eval/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/gan/python/eval/__init__.py).
