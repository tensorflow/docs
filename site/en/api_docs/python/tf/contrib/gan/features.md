...
Defined in [`tensorflow/contrib/gan/python/features/__init__.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/gan/python/features/__init__.py).
