...
Defined in [`tensorflow/contrib/gan/python/features/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/gan/python/features/__init__.py).
