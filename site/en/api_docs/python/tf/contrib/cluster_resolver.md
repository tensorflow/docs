...
Defined in [`tensorflow/contrib/cluster_resolver/__init__.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/cluster_resolver/__init__.py).
