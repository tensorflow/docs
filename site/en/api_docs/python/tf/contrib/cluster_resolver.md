...
Defined in [`tensorflow/contrib/cluster_resolver/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.11/tensorflow/contrib/cluster_resolver/__init__.py).
