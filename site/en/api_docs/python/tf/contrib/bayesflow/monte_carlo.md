...
Defined in [`tensorflow/contrib/bayesflow/python/ops/monte_carlo.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/bayesflow/python/ops/monte_carlo.py).
