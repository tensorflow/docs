...
Defined in [`tensorflow/contrib/bayesflow/python/ops/stochastic_gradient_estimators.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/bayesflow/python/ops/stochastic_gradient_estimators.py).
