...
Defined in [`tensorflow/contrib/bayesflow/python/ops/monte_carlo_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/bayesflow/python/ops/monte_carlo_impl.py).
