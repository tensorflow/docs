...
Defined in [`tensorflow/contrib/bayesflow/python/ops/entropy_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/bayesflow/python/ops/entropy_impl.py).
