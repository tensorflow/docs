...
Defined in [`tensorflow/contrib/bayesflow/python/ops/halton_sequence_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/bayesflow/python/ops/halton_sequence_impl.py).
