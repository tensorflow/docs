...
Defined in [`tensorflow/contrib/bayesflow/python/ops/variational_sgd_optimizer.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/bayesflow/python/ops/variational_sgd_optimizer.py).
