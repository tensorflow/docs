...
# tf.contrib.bayesflow.optimizers.SGLDOptimizer
...
Defined in [`tensorflow/contrib/bayesflow/python/ops/sgld_optimizer.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/bayesflow/python/ops/sgld_optimizer.py).
...
* <b>`num_pseudo_batches`</b>: Scalar `int`-like `Tensor`. The effective number of
