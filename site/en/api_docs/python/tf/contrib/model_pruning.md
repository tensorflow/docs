...
Defined in [`tensorflow/contrib/model_pruning/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/model_pruning/__init__.py).
