...
Defined in [`tensorflow/contrib/model_pruning/__init__.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/model_pruning/__init__.py).
