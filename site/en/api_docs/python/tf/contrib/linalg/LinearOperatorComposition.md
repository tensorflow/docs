...
Defined in [`tensorflow/contrib/linalg/python/ops/linear_operator_composition.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/linalg/python/ops/linear_operator_composition.py).
