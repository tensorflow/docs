...
<h3 id="__init__"><code>__init__(operators, is_non_singular=None, is_self_adjoint=None, is_positive_definite=None, name=None)</code></h3>
...
Defined in [`tensorflow/contrib/linalg/python/ops/linear_operator_composition.py`](https://www.tensorflow.org/code/tensorflow/contrib/linalg/python/ops/linear_operator_composition.py).
