...
<h3 id="__init__"><code>__init__(tril, is_non_singular=None, is_self_adjoint=None, is_positive_definite=None, name='LinearOperatorTriL')</code></h3>
...
Defined in [`tensorflow/contrib/linalg/python/ops/linear_operator_tril.py`](https://www.tensorflow.org/code/tensorflow/contrib/linalg/python/ops/linear_operator_tril.py).
