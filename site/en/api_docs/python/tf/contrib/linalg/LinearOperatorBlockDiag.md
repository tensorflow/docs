...
# tf.contrib.linalg.LinearOperatorBlockDiag
...
Defined in [`tensorflow/contrib/linalg/python/ops/linear_operator_block_diag.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/linalg/python/ops/linear_operator_block_diag.py).
