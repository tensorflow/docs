...
Defined in [`tensorflow/contrib/rnn/python/ops/lstm_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/rnn/python/ops/lstm_ops.py).
