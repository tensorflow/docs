...
Defined in [`tensorflow/contrib/rnn/python/ops/lstm_ops.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/rnn/python/ops/lstm_ops.py).
