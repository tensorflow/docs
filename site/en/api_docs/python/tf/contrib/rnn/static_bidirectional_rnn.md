...
Defined in [`tensorflow/contrib/rnn/python/ops/core_rnn.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/rnn/python/ops/core_rnn.py).
