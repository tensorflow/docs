...
Defined in [`tensorflow/contrib/rnn/python/ops/lstm_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/rnn/python/ops/lstm_ops.py).
