...
Defined in [`tensorflow/contrib/rnn/python/ops/core_rnn_cell.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/rnn/python/ops/core_rnn_cell.py).
