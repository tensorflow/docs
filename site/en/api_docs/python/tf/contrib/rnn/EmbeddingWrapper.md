...
Defined in [`tensorflow/contrib/rnn/python/ops/core_rnn_cell.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/rnn/python/ops/core_rnn_cell.py).
