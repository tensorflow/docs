...
Defined in [`tensorflow/contrib/rnn/python/ops/core_rnn_cell.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.9/tensorflow/contrib/rnn/python/ops/core_rnn_cell.py).
