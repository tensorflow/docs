...
Defined in [`tensorflow/contrib/rnn/python/ops/fused_rnn_cell.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/rnn/python/ops/fused_rnn_cell.py).
