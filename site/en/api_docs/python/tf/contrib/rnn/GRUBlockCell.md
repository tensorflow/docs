...
Defined in [`tensorflow/contrib/rnn/python/ops/gru_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/rnn/python/ops/gru_ops.py).
