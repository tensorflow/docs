...
Defined in [`tensorflow/contrib/rnn/python/ops/gru_ops.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/rnn/python/ops/gru_ops.py).
