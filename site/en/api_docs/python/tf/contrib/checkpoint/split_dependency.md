...
Defined in [`contrib/checkpoint/python/split_dependency.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/checkpoint/python/split_dependency.py).
