...
Defined in [`tensorflow/contrib/remote_fused_graph/pylib/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/remote_fused_graph/pylib/__init__.py).
