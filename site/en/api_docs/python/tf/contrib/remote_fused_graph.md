...
Defined in [`tensorflow/contrib/remote_fused_graph/pylib/__init__.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/remote_fused_graph/pylib/__init__.py).
