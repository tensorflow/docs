...
### `class tf.contrib.cloud.BigQueryReader`



Defined in [`tensorflow/contrib/cloud/python/ops/bigquery_reader_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/cloud/python/ops/bigquery_reader_ops.py).
