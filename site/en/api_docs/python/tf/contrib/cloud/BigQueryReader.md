...
Defined in [`tensorflow/contrib/cloud/python/ops/bigquery_reader_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/cloud/python/ops/bigquery_reader_ops.py).
