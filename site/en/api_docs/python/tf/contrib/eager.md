...
Defined in [`tensorflow/contrib/eager/python/tfe.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/eager/python/tfe.py).
...
[`value_and_gradients_function(...)`](../../tf/contrib/eager/value_and_gradients_function): Returns a function that computes f and is derivative w.r.t. params.
