...
Defined in [`tensorflow/contrib/image/python/ops/interpolate_spline.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/image/python/ops/interpolate_spline.py).
