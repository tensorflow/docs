...
Defined in [`tensorflow/contrib/signal/python/ops/mfcc_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/signal/python/ops/mfcc_ops.py).
