...
Defined in [`tensorflow/contrib/signal/python/ops/mfcc_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/signal/python/ops/mfcc_ops.py).
