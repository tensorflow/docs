...
Defined in [`tensorflow/contrib/signal/python/ops/reconstruction_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/signal/python/ops/reconstruction_ops.py).
