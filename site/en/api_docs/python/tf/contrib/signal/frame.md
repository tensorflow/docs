...
Defined in [`tensorflow/contrib/signal/python/ops/shape_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/signal/python/ops/shape_ops.py).
