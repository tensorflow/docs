...
Inherits From: [`BasicLSTMCell`](../../../tf/contrib/rnn/BasicLSTMCell)



Defined in [`tensorflow/contrib/model_pruning/python/layers/rnn_cells.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/model_pruning/python/layers/rnn_cells.py).
...
For advanced models, please use the full <a href="../../../tf/contrib/rnn/LSTMCell"><code>tf.nn.rnn_cell.LSTMCell</code></a>
that follows.
