...
Defined in [`tensorflow/contrib/model_pruning/python/layers/rnn_cells.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/model_pruning/python/layers/rnn_cells.py).
