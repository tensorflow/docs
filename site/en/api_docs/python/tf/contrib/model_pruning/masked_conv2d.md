...
Defined in [`tensorflow/contrib/model_pruning/python/layers/layers.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/model_pruning/python/layers/layers.py).
