...
Defined in [`contrib/model_pruning/python/learning.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/model_pruning/python/learning.py).
...
* <b>`local_init_op`</b>: The local initialization operation. If left to its default
  ...
  <a href="../../../tf/initializers/local_variables"><code>tf.compat.v1.local_variables_initializer()</code></a> and
...
* <b>`session_config`</b>: An instance of <a href="../../../tf/ConfigProto"><code>tf.compat.v1.ConfigProto</code></a> that will be used
