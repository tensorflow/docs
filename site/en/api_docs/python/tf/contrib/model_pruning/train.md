...
Defined in [`tensorflow/contrib/model_pruning/python/learning.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/model_pruning/python/learning.py).
...
* <b>`session_config`</b>: An instance of `tf.ConfigProto` that will be used to
