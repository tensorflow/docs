...
Defined in [`tensorflow/contrib/rnn/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/rnn/__init__.py).
...
[`transpose_batch_time(...)`](../../tf/contrib/rnn/transpose_batch_time): Transpose the batch and time dimensions of a Tensor.
