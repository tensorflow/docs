...
Defined in [`tensorflow/contrib/tpu/python/tpu/device_assignment.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/tpu/python/tpu/device_assignment.py).
