...
Defined in [`tensorflow/contrib/tpu/python/tpu/training_loop.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/tpu/python/tpu/training_loop.py).
