...
Defined in [`tensorflow/contrib/tpu/python/tpu/keras_support.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/tpu/python/tpu/keras_support.py).
