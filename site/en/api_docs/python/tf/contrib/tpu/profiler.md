...
Defined in [`tensorflow/contrib/tpu/python/profiler/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/tpu/python/profiler/__init__.py).
