...
Defined in [`tensorflow/contrib/tpu/python/profiler/__init__.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/tpu/python/profiler/__init__.py).
