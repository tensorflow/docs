...
Defined in [`tensorflow/contrib/tpu/python/profiler/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/tpu/python/profiler/__init__.py).
