...
Defined in [`tensorflow/contrib/tpu/python/tpu/async_checkpoint.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/tpu/python/tpu/async_checkpoint.py).
