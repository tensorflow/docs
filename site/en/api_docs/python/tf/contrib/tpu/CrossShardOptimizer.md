...
Defined in [`tensorflow/contrib/tpu/python/tpu/tpu_optimizer.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/tpu/python/tpu/tpu_optimizer.py).
