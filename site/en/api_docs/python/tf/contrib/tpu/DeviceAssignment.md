...
Defined in [`tensorflow/contrib/tpu/python/tpu/device_assignment.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/tpu/python/tpu/device_assignment.py).
...
* <b>`ValueError`</b>: If no replica exisis in the task which contains the logical
  core.
