...
Defined in [`tensorflow/contrib/tpu/python/tpu/topology.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/tpu/python/tpu/topology.py).
