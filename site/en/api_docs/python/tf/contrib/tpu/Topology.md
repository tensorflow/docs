...
Defined in [`tensorflow/contrib/tpu/python/tpu/topology.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/tpu/python/tpu/topology.py).
