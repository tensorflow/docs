...
Defined in [`tensorflow/contrib/tpu/python/tpu/tpu_feed.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/tpu/python/tpu/tpu_feed.py).
