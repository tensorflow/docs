...
Defined in [`tensorflow/contrib/tpu/python/tpu/tpu_estimator.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/tpu/python/tpu/tpu_estimator.py).
...
* <b>`eval_batch_size`</b>: An int representing the global training batch size.
