...
Defined in [`tensorflow/contrib/losses/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/losses/__init__.py).

Ops for building neural network losses.

See [Losses (contrib)](../../../../api_guides/python/contrib.losses).
...
[`cosine_distance(...)`](../../tf/contrib/losses/cosine_distance): Adds a cosine-distance loss to the training procedure. (deprecated)
...
[`sparse_softmax_cross_entropy(...)`](../../tf/contrib/losses/sparse_softmax_cross_entropy): Cross-entropy loss using `tf.nn.sparse_softmax_cross_entropy_with_logits`. (deprecated)
