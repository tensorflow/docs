...
Defined in [`tensorflow/contrib/linear_optimizer/python/sdca_optimizer.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/linear_optimizer/python/sdca_optimizer.py).
