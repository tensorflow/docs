...
Defined in [`tensorflow/contrib/linear_optimizer/python/ops/sdca_ops.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/linear_optimizer/python/ops/sdca_ops.py).
