...
### `class tf.contrib.seq2seq.ScheduledEmbeddingTrainingHelper`



Defined in [`tensorflow/contrib/seq2seq/python/ops/helper.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/seq2seq/python/ops/helper.py).
