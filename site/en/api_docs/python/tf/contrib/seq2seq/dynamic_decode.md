...
Defined in [`tensorflow/contrib/seq2seq/python/ops/decoder.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/seq2seq/python/ops/decoder.py).
