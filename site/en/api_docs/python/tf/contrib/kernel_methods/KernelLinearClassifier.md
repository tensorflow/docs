...
Defined in [`tensorflow/contrib/kernel_methods/python/kernel_estimators.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/kernel_methods/python/kernel_estimators.py).
