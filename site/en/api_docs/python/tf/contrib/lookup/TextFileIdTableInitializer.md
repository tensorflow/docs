...
### `class tf.contrib.lookup.TextFileIdTableInitializer`
...
<h3 id="__init__"><code>__init__(filename, key_column_index=TextFileIndex.WHOLE_LINE, value_column_index=TextFileIndex.LINE_NUMBER, vocab_size=None, delimiter='\t', name='text_file_id_table_init')</code></h3>
...
<h3 id="initialize"><code>initialize(table)</code></h3>
