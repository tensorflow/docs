...
Defined in [`tensorflow/contrib/nn/python/ops/scaled_softplus.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/nn/python/ops/scaled_softplus.py).
