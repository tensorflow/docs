...
Defined in [`tensorflow/contrib/nn/python/ops/scaled_softplus.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/nn/python/ops/scaled_softplus.py).
