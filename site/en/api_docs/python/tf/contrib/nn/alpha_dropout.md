...
Defined in [`tensorflow/contrib/nn/python/ops/alpha_dropout.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/nn/python/ops/alpha_dropout.py).
