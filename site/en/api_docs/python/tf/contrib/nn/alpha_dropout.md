...
Defined in [`tensorflow/contrib/nn/python/ops/alpha_dropout.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/nn/python/ops/alpha_dropout.py).
