...
Defined in [`tensorflow/contrib/nn/python/ops/sampling_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/nn/python/ops/sampling_ops.py).
