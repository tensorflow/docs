...
Defined in [`tensorflow/contrib/nn/python/ops/cross_entropy.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/nn/python/ops/cross_entropy.py).
