...
Defined in [`tensorflow/contrib/integrate/python/ops/odes.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/integrate/python/ops/odes.py).
