...
Defined in [`tensorflow/contrib/integrate/python/ops/odes.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/integrate/python/ops/odes.py).
