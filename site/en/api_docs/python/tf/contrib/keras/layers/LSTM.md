...
### `class tf.contrib.keras.layers.LSTM`



Defined in [`tensorflow/contrib/keras/python/keras/layers/recurrent.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/keras/python/keras/layers/recurrent.py).
