...
Defined in [`tensorflow/contrib/keras/python/keras/layers/noise.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/keras/python/keras/layers/noise.py).
