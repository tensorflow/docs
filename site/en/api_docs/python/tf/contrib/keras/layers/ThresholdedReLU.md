...
### `class tf.contrib.keras.layers.ThresholdedReLU`



Defined in [`tensorflow/contrib/keras/python/keras/layers/advanced_activations.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/keras/python/keras/layers/advanced_activations.py).
