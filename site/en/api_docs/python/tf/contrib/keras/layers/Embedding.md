...
Defined in [`tensorflow/contrib/keras/python/keras/layers/embeddings.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/keras/python/keras/layers/embeddings.py).
