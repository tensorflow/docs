...
### `class tf.contrib.keras.layers.ConvLSTM2D`



Defined in [`tensorflow/contrib/keras/python/keras/layers/convolutional_recurrent.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/keras/python/keras/layers/convolutional_recurrent.py).
