...
### `class tf.contrib.keras.layers.GlobalAveragePooling1D`
### `class tf.contrib.keras.layers.GlobalAvgPool1D`



Defined in [`tensorflow/contrib/keras/python/keras/layers/pooling.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/keras/python/keras/layers/pooling.py).
