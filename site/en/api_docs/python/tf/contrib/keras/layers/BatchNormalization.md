...
### `class tf.contrib.keras.layers.BatchNormalization`



Defined in [`tensorflow/contrib/keras/python/keras/layers/normalization.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/keras/python/keras/layers/normalization.py).
