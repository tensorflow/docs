...
### `class tf.contrib.keras.layers.LocallyConnected2D`



Defined in [`tensorflow/contrib/keras/python/keras/layers/local.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/keras/python/keras/layers/local.py).
