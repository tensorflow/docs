...
Defined in [`tensorflow/contrib/keras/python/keras/engine/training.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/keras/python/keras/engine/training.py).
