...
Defined in [`tensorflow/contrib/keras/python/keras/constraints.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/contrib/keras/python/keras/constraints.py).
