...
Defined in [`tensorflow/contrib/keras/api/keras/backend/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/keras/api/keras/backend/__init__.py).
