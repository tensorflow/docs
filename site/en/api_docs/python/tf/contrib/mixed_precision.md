...
Defined in [`tensorflow/contrib/mixed_precision/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/mixed_precision/__init__.py).
