...
Defined in [`tensorflow/contrib/mixed_precision/__init__.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/mixed_precision/__init__.py).
