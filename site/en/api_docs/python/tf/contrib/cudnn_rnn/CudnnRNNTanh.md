...
Defined in [`tensorflow/contrib/cudnn_rnn/python/layers/cudnn_rnn.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/cudnn_rnn/python/layers/cudnn_rnn.py).
