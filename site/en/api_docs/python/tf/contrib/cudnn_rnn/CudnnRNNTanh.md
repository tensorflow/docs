...
Defined in [`tensorflow/contrib/cudnn_rnn/python/layers/cudnn_rnn.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/cudnn_rnn/python/layers/cudnn_rnn.py).
...
* <b>`dropout`</b>: dropout rate, a number between [0, 1]. Dropout is applied on
