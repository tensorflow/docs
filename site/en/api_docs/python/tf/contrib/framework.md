...
Defined in [`tensorflow/contrib/framework/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/framework/__init__.py).

Framework utilities.

See the [Framework (contrib)](../../../../api_guides/python/contrib.framework) guide.
