...
Defined in [`tensorflow/contrib/data/python/ops/readers.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/data/python/ops/readers.py).
...
Creates a `TextLineDataset`. (deprecated)
...
* <b>`buffer_size`</b>: (Optional.) A `tf.int64` scalar denoting the number of bytes
...
identical results = to <a href="../../../tf/contrib/data/Dataset#flat_map"><code>tf.contrib.data.Dataset.flat_map</code></a>. In general,
