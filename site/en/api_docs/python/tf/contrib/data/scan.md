...
Defined in [`tensorflow/contrib/data/python/ops/scan_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/data/python/ops/scan_ops.py).
...
<a href="../../../tf/contrib/data/Dataset#apply"><code>tf.contrib.data.Dataset.apply</code></a>.