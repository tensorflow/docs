...
Defined in [`tensorflow/contrib/data/python/ops/scan_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/data/python/ops/scan_ops.py).
