...
Defined in [`tensorflow/contrib/data/python/ops/resampling.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/data/python/ops/resampling.py).
