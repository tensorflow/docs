...
Defined in [`tensorflow/contrib/data/python/ops/parsing_ops.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/data/python/ops/parsing_ops.py).
