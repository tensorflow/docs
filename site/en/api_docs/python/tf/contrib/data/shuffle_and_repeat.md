...
Defined in [`tensorflow/contrib/data/python/ops/shuffle_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/data/python/ops/shuffle_ops.py).
