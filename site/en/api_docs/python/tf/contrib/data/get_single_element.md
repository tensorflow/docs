...
Defined in [`tensorflow/contrib/data/python/ops/get_single_element.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.11/tensorflow/contrib/data/python/ops/get_single_element.py).
