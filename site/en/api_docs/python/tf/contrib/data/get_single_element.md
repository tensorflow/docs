...
Defined in [`tensorflow/contrib/data/python/ops/get_single_element.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/data/python/ops/get_single_element.py).
