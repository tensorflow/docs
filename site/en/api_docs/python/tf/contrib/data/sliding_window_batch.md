...
Defined in [`tensorflow/contrib/data/python/ops/sliding.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/data/python/ops/sliding.py).
...
* <b>`stride`</b>: (Optional.) A `tf.int64` scalar `tf.Tensor`, representing the
