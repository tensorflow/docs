...
Defined in [`tensorflow/contrib/data/python/ops/sliding.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/data/python/ops/sliding.py).
