...
Defined in [`tensorflow/contrib/data/python/ops/grouping.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/data/python/ops/grouping.py).
...
* <b>`element_length_func`</b>: function from element in `Dataset` to `tf.int64`,
...
* <b>`padded_shapes`</b>: Nested structure of `tf.TensorShape` to pass to
