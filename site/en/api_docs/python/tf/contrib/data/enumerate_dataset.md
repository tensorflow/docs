...
Defined in [`tensorflow/contrib/data/python/ops/enumerate_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/data/python/ops/enumerate_ops.py).
