...
Defined in [`tensorflow/contrib/estimator/python/estimator/logit_fns.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/estimator/python/estimator/logit_fns.py).
