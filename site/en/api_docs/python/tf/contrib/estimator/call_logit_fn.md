...
Defined in [`tensorflow/contrib/estimator/python/estimator/logit_fns.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/estimator/python/estimator/logit_fns.py).
