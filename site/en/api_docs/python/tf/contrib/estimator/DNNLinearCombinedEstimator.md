...
Defined in [`tensorflow/contrib/estimator/python/estimator/dnn_linear_combined.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/estimator/python/estimator/dnn_linear_combined.py).
