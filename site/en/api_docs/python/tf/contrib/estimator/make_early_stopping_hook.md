...
Defined in [`tensorflow/contrib/estimator/python/estimator/early_stopping.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/estimator/python/estimator/early_stopping.py).
...
* <b>`estimator`</b>: A `tf.estimator.Estimator` instance.
...
* <b>`TypeError`</b>: If `estimator` is not of type `tf.estimator.Estimator`.
