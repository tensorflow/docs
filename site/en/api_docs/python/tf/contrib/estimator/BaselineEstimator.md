...
Defined in [`tensorflow/contrib/estimator/python/estimator/baseline.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/estimator/python/estimator/baseline.py).
