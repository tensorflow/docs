...
Defined in [`tensorflow/contrib/estimator/python/estimator/linear.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/estimator/python/estimator/linear.py).
