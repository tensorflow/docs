...
Defined in [`tensorflow/contrib/constrained_optimization/python/swap_regret_optimizer.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/constrained_optimization/python/swap_regret_optimizer.py).
...
the differences being that it uses <a href="../../../tf/train/Optimizer"><code>tf.train.Optimizer</code></a>s, instead of SGD, for
