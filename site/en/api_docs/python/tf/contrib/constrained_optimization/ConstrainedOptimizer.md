...
Defined in [`tensorflow/contrib/constrained_optimization/python/constrained_optimizer.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/constrained_optimization/python/constrained_optimizer.py).
