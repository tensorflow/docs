...
Defined in [`tensorflow/contrib/quantize/python/quantize_graph.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/quantize/python/quantize_graph.py).
