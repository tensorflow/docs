...
Defined in [`tensorflow/contrib/stat_summarizer/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/stat_summarizer/__init__.py).
