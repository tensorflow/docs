...
Defined in [`tensorflow/contrib/bigtable/python/ops/bigtable_api.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/bigtable/python/ops/bigtable_api.py).
