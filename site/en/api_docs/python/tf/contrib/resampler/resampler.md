...
Defined in [`tensorflow/contrib/resampler/python/ops/resampler_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.9/tensorflow/contrib/resampler/python/ops/resampler_ops.py).
