...
Defined in [`tensorflow/contrib/timeseries/python/timeseries/estimators.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/timeseries/python/timeseries/estimators.py).
...
shape [batch size] (dtype <a href="../../../tf/dtypes#string"><code>tf.string</code></a>), each tf.Example containing
