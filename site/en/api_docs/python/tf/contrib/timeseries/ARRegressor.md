...
Defined in [`contrib/timeseries/python/timeseries/estimators.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/timeseries/python/timeseries/estimators.py).
