...
Defined in [`tensorflow/contrib/timeseries/python/timeseries/input_pipeline.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/timeseries/python/timeseries/input_pipeline.py).
