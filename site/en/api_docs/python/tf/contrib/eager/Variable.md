...
Defined in [`tensorflow/python/ops/resource_variable_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/ops/resource_variable_ops.py).
