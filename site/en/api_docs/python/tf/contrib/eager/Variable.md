...
Defined in [`tensorflow/python/ops/resource_variable_ops.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/ops/resource_variable_ops.py).
