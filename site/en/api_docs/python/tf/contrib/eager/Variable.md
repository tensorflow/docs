...
Defined in [`tensorflow/python/ops/resource_variable_ops.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/ops/resource_variable_ops.py).
