...
Defined in [`tensorflow/python/ops/resource_variable_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/ops/resource_variable_ops.py).

Variable based on resource handles.

See the <a href="../../../../../api_guides/python/state_ops"><code>Variables</code></a> documentation for more details.
