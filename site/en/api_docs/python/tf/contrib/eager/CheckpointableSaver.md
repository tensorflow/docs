...
Defined in [`tensorflow/contrib/eager/python/checkpointable_utils.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/eager/python/checkpointable_utils.py).
