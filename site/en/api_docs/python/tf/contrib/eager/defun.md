...
Defined in [`tensorflow/python/eager/function.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/eager/function.py).
...
or more <a href="../../../tf/Tensor"><code>tf.Tensor</code></a> objects.
