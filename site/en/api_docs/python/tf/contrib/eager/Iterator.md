...
Defined in [`tensorflow/contrib/eager/python/datasets.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/eager/python/datasets.py).
