...
Defined in [`tensorflow/contrib/eager/python/network.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/eager/python/network.py).
...
* <b>`layer`</b>: A `tf.layers.Layer` object.
