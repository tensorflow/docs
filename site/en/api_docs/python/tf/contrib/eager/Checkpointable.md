...
Defined in [`tensorflow/python/training/checkpointable.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/python/training/checkpointable.py).
