...
Defined in [`tensorflow/contrib/eager/python/metrics.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/eager/python/metrics.py).
