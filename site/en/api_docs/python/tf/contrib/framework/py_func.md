...
Defined in [`tensorflow/contrib/framework/python/ops/script_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/framework/python/ops/script_ops.py).
