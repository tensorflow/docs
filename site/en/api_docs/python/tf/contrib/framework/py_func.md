...
Defined in [`tensorflow/contrib/framework/python/ops/script_ops.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/framework/python/ops/script_ops.py).

Wraps a python function and uses it as a TensorFlow op.

This function is a wrapper around <a href="../../../tf/py_func"><code>tf.py_func</code></a> and improve it with kwargs
