...
Defined in [`contrib/framework/python/ops/script_ops.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/framework/python/ops/script_ops.py).
