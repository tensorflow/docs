...
Defined in [`tensorflow/python/util/nest.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/util/nest.py).
...
[`assert_same_structure(...)`](../../../tf/contrib/framework/nest/assert_same_structure): Asserts that two structures are nested in the same way.
