...
Defined in [`tensorflow/python/framework/smart_cond.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/framework/smart_cond.py).
...
* <b>`name`</b>: Optional name prefix when using `tf.cond`.
