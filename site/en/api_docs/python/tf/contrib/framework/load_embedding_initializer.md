...
Defined in [`tensorflow/python/training/checkpoint_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/training/checkpoint_ops.py).
