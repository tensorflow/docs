...
Defined in [`tensorflow/contrib/framework/python/ops/ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/framework/python/ops/ops.py).
