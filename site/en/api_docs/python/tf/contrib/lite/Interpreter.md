...
Defined in [`tensorflow/contrib/lite/python/interpreter.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/contrib/lite/python/interpreter.py).
