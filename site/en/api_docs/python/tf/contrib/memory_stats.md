...
Defined in [`tensorflow/contrib/memory_stats/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/memory_stats/__init__.py).
