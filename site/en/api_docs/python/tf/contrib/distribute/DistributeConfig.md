...
Defined in [`tensorflow/python/distribute/distribute_config.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/distribute/distribute_config.py).
