...
Defined in [`tensorflow/contrib/distribute/python/one_device_strategy.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/distribute/python/one_device_strategy.py).
