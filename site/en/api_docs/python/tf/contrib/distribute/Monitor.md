...
Defined in [`tensorflow/contrib/distribute/python/monitor.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/distribute/python/monitor.py).
