...
Defined in [`contrib/distribute/python/parameter_server_strategy.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/distribute/python/parameter_server_strategy.py).
