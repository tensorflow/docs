...
Defined in [`tensorflow/contrib/distribute/python/parameter_server_strategy.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/distribute/python/parameter_server_strategy.py).
