...
Inherits From: [`MirroredStrategy`](../../../tf/contrib/distribute/MirroredStrategy)



Defined in [`tensorflow/contrib/distribute/python/collective_all_reduce_strategy.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/distribute/python/collective_all_reduce_strategy.py).
...
* <b>`session_config`</b>: a <a href="../../../tf/ConfigProto"><code>tf.ConfigProto</code></a>
