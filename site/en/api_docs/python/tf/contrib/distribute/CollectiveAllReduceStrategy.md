...
Defined in [`contrib/distribute/python/collective_all_reduce_strategy.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/distribute/python/collective_all_reduce_strategy.py).
