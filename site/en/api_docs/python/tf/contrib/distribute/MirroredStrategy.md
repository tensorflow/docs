...
Defined in [`contrib/distribute/python/mirrored_strategy.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/distribute/python/mirrored_strategy.py).
