...
Defined in [`tensorflow/contrib/distribute/python/tpu_strategy.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/distribute/python/tpu_strategy.py).
