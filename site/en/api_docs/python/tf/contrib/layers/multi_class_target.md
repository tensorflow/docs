...
Defined in [`tensorflow/contrib/layers/python/layers/target_column.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/layers/python/layers/target_column.py).
