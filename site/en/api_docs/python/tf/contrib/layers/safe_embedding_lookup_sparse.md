...
Defined in [`tensorflow/contrib/layers/python/layers/embedding_ops.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/layers/python/layers/embedding_ops.py).
