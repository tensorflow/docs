...
Defined in [`tensorflow/contrib/layers/python/layers/optimizers.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/layers/python/layers/optimizers.py).
