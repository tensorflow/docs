...
Defined in [`tensorflow/contrib/layers/python/layers/optimizers.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/layers/python/layers/optimizers.py).
