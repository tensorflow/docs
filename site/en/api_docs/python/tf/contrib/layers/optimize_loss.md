...
Defined in [`contrib/layers/python/layers/optimizers.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/layers/python/layers/optimizers.py).
...
* <b>`global_step`</b>: Scalar int `Tensor`, step counter to update on each step unless
  ...
  from the default graph (see <a href="../../../tf/train/get_global_step"><code>tf.compat.v1.train.get_global_step</code></a> for
...
* <b>`learning_rate_decay_fn`</b>: function, takes `learning_rate` and `global_step`
  ...
  decay functions.
                        For example: <a href="../../../tf/train/exponential_decay"><code>tf.compat.v1.train.exponential_decay</code></a>.
