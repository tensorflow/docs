...
Defined in [`tensorflow/contrib/factorization/python/ops/factorization_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/factorization/python/ops/factorization_ops.py).
