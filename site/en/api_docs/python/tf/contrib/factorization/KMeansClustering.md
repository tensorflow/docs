...
Defined in [`tensorflow/contrib/factorization/python/ops/kmeans.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/factorization/python/ops/kmeans.py).
