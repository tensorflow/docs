...
Defined in [`contrib/factorization/python/ops/kmeans.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/factorization/python/ops/kmeans.py).
