...
Defined in [`tensorflow/contrib/factorization/python/ops/kmeans.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.11/tensorflow/contrib/factorization/python/ops/kmeans.py).
