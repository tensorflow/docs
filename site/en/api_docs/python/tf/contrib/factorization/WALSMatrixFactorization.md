...
Defined in [`tensorflow/contrib/factorization/python/ops/wals.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/factorization/python/ops/wals.py).
