...
Defined in [`tensorflow/contrib/linalg/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/linalg/__init__.py).
...
[`class LinearOperatorBlockDiag`](../../tf/contrib/linalg/LinearOperatorBlockDiag): Combines one or more `LinearOperators` in to a Block Diagonal matrix.
