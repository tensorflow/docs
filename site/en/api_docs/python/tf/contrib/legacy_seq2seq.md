...
Defined in [`tensorflow/contrib/legacy_seq2seq/__init__.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/legacy_seq2seq/__init__.py).
