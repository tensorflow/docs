...
Defined in [`tensorflow/contrib/legacy_seq2seq/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/legacy_seq2seq/__init__.py).
