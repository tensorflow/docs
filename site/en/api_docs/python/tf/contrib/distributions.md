...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/__init__.py">
...
[`class BatchReshape`](../../tf/contrib/distributions/BatchReshape): The Batch-Reshaping distribution.
...
[`class Kumaraswamy`](../../tf/contrib/distributions/Kumaraswamy): Kumaraswamy distribution.
...
[`class SeedStream`](../../tf/contrib/distributions/SeedStream): Local PRNG for amplifying seed entropy into seeds for base operations.
