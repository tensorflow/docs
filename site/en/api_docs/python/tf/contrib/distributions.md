...
Defined in [`tensorflow/contrib/distributions/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/distributions/__init__.py).
...
[`class StudentT`](../../tf/contrib/distributions/StudentT): Student's t-distribution.
...
[`kl_divergence(...)`](../../tf/contrib/distributions/kl_divergence): Get the KL-divergence KL(distribution_a || distribution_b).
