...
[`string_to_index_table_from_file(...)`](../../tf/contrib/lookup/string_to_index_table_from_file): Returns a lookup table that converts a string tensor into int64 IDs.

[`string_to_index_table_from_tensor(...)`](../../tf/contrib/lookup/string_to_index_table_from_tensor): Returns a lookup table that converts a string tensor into int64 IDs.
