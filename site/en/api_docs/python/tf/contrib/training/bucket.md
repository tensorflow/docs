...
Defined in [`tensorflow/contrib/training/python/training/bucket_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/contrib/training/python/training/bucket_ops.py).
