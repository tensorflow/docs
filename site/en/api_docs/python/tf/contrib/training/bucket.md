...
Defined in [`tensorflow/contrib/training/python/training/bucket_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/training/python/training/bucket_ops.py).
...
them will throw a <a href="../../../tf/errors/OutOfRangeError"><code>tf.errors.OutOfRangeError</code></a> when the input queue is
