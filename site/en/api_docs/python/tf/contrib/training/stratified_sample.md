...
Defined in [`contrib/training/python/training/sampling_ops.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/contrib/training/python/training/sampling_ops.py).
