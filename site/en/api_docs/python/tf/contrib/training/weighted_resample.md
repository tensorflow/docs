...
Defined in [`tensorflow/contrib/training/python/training/resample.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/contrib/training/python/training/resample.py).
