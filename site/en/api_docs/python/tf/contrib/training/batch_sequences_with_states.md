...
Defined in [`tensorflow/contrib/training/python/training/sequence_queueing_state_saver.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/contrib/training/python/training/sequence_queueing_state_saver.py).
