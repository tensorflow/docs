...
Defined in [`tensorflow/contrib/training/python/training/hparam.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/contrib/training/python/training/hparam.py).
