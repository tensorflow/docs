...
Defined in [`tensorflow/contrib/constrained_optimization/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.11/tensorflow/contrib/constrained_optimization/__init__.py).
