...
Defined in [`tensorflow/contrib/constrained_optimization/__init__.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/contrib/constrained_optimization/__init__.py).
