...
Defined in [`tensorflow/contrib/optimizer_v2/optimizer_v2.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/contrib/optimizer_v2/optimizer_v2.py).
