...
Defined in [`tensorflow/contrib/optimizer_v2/gradient_descent.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/contrib/optimizer_v2/gradient_descent.py).
