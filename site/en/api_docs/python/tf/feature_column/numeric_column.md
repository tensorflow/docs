...
* <b>`dtype`</b>: defines the type of values. Default value is <a href="../../tf/dtypes#float32"><code>tf.float32</code></a>. Must be a
...
* <b>`ValueError`</b>: if `dtype` is not convertible to <a href="../../tf/dtypes#float32"><code>tf.float32</code></a>.