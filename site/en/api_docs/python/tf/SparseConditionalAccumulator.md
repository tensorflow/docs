...
<h3 id="__init__"><code>__init__(dtype, shape=None, shared_name=None, name='sparse_conditional_accumulator')</code></h3>



<h3 id="apply_grad"><code>apply_grad(grad_indices, grad_values, grad_shape=None, local_step=0, name=None)</code></h3>
...
<h3 id="apply_indexed_slices_grad"><code>apply_indexed_slices_grad(grad, local_step=0, name=None)</code></h3>
...
<h3 id="num_accumulated"><code>num_accumulated(name=None)</code></h3>
...
<h3 id="set_global_step"><code>set_global_step(new_global_step, name=None)</code></h3>
...
<h3 id="take_grad"><code>take_grad(num_required, name=None)</code></h3>
...
<h3 id="take_indexed_slices_grad"><code>take_indexed_slices_grad(num_required, name=None)</code></h3>
