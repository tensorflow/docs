...
Defined in [`tensorflow/python/ops/variable_scope.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/python/ops/variable_scope.py).
...
[Variable Scope How To](../../../programmers_guide/variable_scope)
...
* <b>`regularizer`</b>: A (Tensor -> Tensor or None) function; the result of
    ...
    [`tf.GraphKeys.REGULARIZATION_LOSSES`](../tf/GraphKeys#REGULARIZATION_LOSSES) and can be used for regularization.
