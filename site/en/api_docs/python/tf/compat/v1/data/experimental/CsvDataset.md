...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r2.4/tensorflow/python/data/experimental/ops/readers.py#L783-L870">
...
<code>tf.compat.v1.data.experimental.CsvDataset(
    ...
    select_cols=None, exclude_cols=None
)
</code></pre>
