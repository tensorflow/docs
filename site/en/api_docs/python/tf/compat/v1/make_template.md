...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/tree/r2.0/tensorflow/python/ops/template.py#L39-L161">
...
* The function should create all trainable variables and any variables that
   should be reused by calling <a href="../../../tf/compat/v1/get_variable"><code>tf.compat.v1.get_variable</code></a>. If a trainable
   variable is
...
* The function may use variable scopes and other templates internally to
    ...
    <a href="../../../tf/compat/v1/global_variables"><code>tf.compat.v1.global_variables</code></a> to
...
first call if trainable variables are created by calling <a href="../../../tf/Variable"><code>tf.Variable</code></a>.
...
* <b>`custom_getter_`</b>: Optional custom getter for variables used in `func_`. See
  the <a href="../../../tf/compat/v1/get_variable"><code>tf.compat.v1.get_variable</code></a> `custom_getter` documentation for more
  information.
