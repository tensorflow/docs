...
[`experimental`](../../../tf/compat/v1/layers/experimental) module: Public API for tf.layers.experimental namespace.
...
[`class SeparableConv1D`](../../../tf/layers/SeparableConv1D): Depthwise separable 1D convolution.

[`class SeparableConv2D`](../../../tf/layers/SeparableConv2D): Depthwise separable 2D convolution.

## Functions

[`average_pooling1d(...)`](../../../tf/layers/average_pooling1d): Average Pooling layer for 1D inputs. (deprecated)

[`average_pooling2d(...)`](../../../tf/layers/average_pooling2d): Average pooling layer for 2D inputs (e.g. images). (deprecated)

[`average_pooling3d(...)`](../../../tf/layers/average_pooling3d): Average pooling layer for 3D inputs (e.g. volumes). (deprecated)

[`batch_normalization(...)`](../../../tf/layers/batch_normalization): Functional interface for the batch normalization layer. (deprecated)

[`conv1d(...)`](../../../tf/layers/conv1d): Functional interface for 1D convolution layer (e.g. temporal convolution). (deprecated)

[`conv2d(...)`](../../../tf/layers/conv2d): Functional interface for the 2D convolution layer. (deprecated)

[`conv2d_transpose(...)`](../../../tf/layers/conv2d_transpose): Functional interface for transposed 2D convolution layer. (deprecated)

[`conv3d(...)`](../../../tf/layers/conv3d): Functional interface for the 3D convolution layer. (deprecated)

[`conv3d_transpose(...)`](../../../tf/layers/conv3d_transpose): Functional interface for transposed 3D convolution layer. (deprecated)

[`dense(...)`](../../../tf/layers/dense): Functional interface for the densely-connected layer. (deprecated)

[`dropout(...)`](../../../tf/layers/dropout): Applies Dropout to the input. (deprecated)

[`flatten(...)`](../../../tf/layers/flatten): Flattens an input tensor while preserving the batch axis (axis 0). (deprecated)

[`max_pooling1d(...)`](../../../tf/layers/max_pooling1d): Max Pooling layer for 1D inputs. (deprecated)
