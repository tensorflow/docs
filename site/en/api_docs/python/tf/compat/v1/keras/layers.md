...
[`class BatchNormalization`](../../../../tf/compat/v1/keras/layers/BatchNormalization): Base class of Batch normalization layer (Ioffe and Szegedy, 2014).
...
[`class CuDNNGRU`](../../../../tf/compat/v1/keras/layers/CuDNNGRU): Fast GRU implementation backed by cuDNN.

[`class CuDNNLSTM`](../../../../tf/compat/v1/keras/layers/CuDNNLSTM): Fast LSTM implementation backed by cuDNN.

[`class Dense`](../../../../tf/keras/layers/Dense): Just your regular densely-connected NN layer.

[`class DenseFeatures`](../../../../tf/compat/v1/keras/layers/DenseFeatures): A layer that produces a dense `Tensor` based on given `feature_columns`.
...
[`class GRU`](../../../../tf/compat/v1/keras/layers/GRU): Gated Recurrent Unit - Cho et al. 2014.

[`class GRUCell`](../../../../tf/compat/v1/keras/layers/GRUCell): Cell class for the GRU layer.
...
[`class LSTM`](../../../../tf/compat/v1/keras/layers/LSTM): Long Short-Term Memory layer - Hochreiter 1997.

[`class LSTMCell`](../../../../tf/compat/v1/keras/layers/LSTMCell): Cell class for the LSTM layer.
