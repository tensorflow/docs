...
[`class name_scope`](../../../../tf/compat/v1/keras/backend/name_scope): A context manager for use when defining a Python op.
...
[`get_session(...)`](../../../../tf/compat/v1/keras/backend/get_session): Returns the TF session to be used by the backend.
...
[`set_session(...)`](../../../../tf/compat/v1/keras/backend/set_session): Sets the global TensorFlow session.
