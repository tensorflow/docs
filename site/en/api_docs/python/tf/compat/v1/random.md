...
[`experimental`](../../../tf/compat/v1/random/experimental) module: Public API for tf.random.experimental namespace.

## Functions

[`all_candidate_sampler(...)`](../../../tf/random/all_candidate_sampler): Generate the set of all classes.

[`categorical(...)`](../../../tf/random/categorical): Draws samples from a categorical distribution.
...
[`get_seed(...)`](../../../tf/compat/v1/get_seed): Returns the local seeds an operation should use given an op-specific seed.
...
[`multinomial(...)`](../../../tf/compat/v1/multinomial): Draws samples from a multinomial distribution. (deprecated)

[`normal(...)`](../../../tf/random/normal): Outputs random values from a normal distribution.

[`poisson(...)`](../../../tf/compat/v1/random_poisson): Draws `shape` samples from each of the given Poisson distribution(s).

[`set_random_seed(...)`](../../../tf/compat/v1/set_random_seed): Sets the graph-level random seed for the default graph.
...
[`stateless_multinomial(...)`](../../../tf/compat/v1/random/stateless_multinomial): Draws deterministic pseudorandom samples from a multinomial distribution. (deprecated)
...
[`stateless_uniform(...)`](../../../tf/random/stateless_uniform): Outputs deterministic pseudorandom values from a uniform distribution.
