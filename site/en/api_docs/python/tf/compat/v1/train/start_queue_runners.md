...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/tree/r2.0/tensorflow/python/training/queue_runner_impl.py#L414-L480">
...
* <b>`TypeError`</b>: if `sess` is not a <a href="../../../../tf/compat/v1/Session"><code>tf.compat.v1.Session</code></a> object.
...
* <b>`ValueError`</b>: If called without a default <a href="../../../../tf/compat/v1/Session"><code>tf.compat.v1.Session</code></a> registered.
