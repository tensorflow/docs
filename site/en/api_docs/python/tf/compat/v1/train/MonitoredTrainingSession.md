...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/tree/r2.0/tensorflow/python/training/monitored_session.py#L420-L584">
...
initialize/restore. Please check <a href="../../../../tf/compat/v1/train/MonitoredSession"><code>tf.compat.v1.train.MonitoredSession</code></a> for
more
information.
...
* <b>`config`</b>: an instance of <a href="../../../../tf/compat/v1/ConfigProto"><code>tf.compat.v1.ConfigProto</code></a> proto used to configure
  the session. It's the `config` argument of constructor of
  <a href="../../../../tf/compat/v1/Session"><code>tf.compat.v1.Session</code></a>.
