...
<td>
  <a target="_blank" href="/api_docs/python/tf/compat/v2/config">
...
[`experimental`](../../../tf/compat/v2/config/experimental) module: Public API for tf.config.experimental namespace.

[`optimizer`](../../../tf/compat/v2/config/optimizer) module: Public API for tf.config.optimizer namespace.

[`threading`](../../../tf/compat/v2/config/threading) module: Public API for tf.config.threading namespace.
...
[`experimental_run_functions_eagerly(...)`](../../../tf/config/experimental_run_functions_eagerly): Enables / disables eager execution of <a href="../../../tf/function"><code>tf.function</code></a>s.
