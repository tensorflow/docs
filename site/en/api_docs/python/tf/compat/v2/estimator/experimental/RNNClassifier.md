...
Inherits From: [`RNNEstimator`](../../../../../tf/compat/v2/estimator/experimental/RNNEstimator)
...
* <b>`rnn_cell_fn`</b>: A function that returns a RNN cell instance that will be used
  ...
  `units` and `cell_type`. Note that <a href="../../../../../tf/keras/layers/StackedRNNCells"><code>tf.keras.layers.StackedRNNCells</code></a> is
...
See the documentation on <a href="../../../../../tf/keras/layers/RNN"><code>tf.keras.layers.RNN</code></a> for more details.
