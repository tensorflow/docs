...
[`cluster_resolver`](../../../tf/compat/v2/distribute/cluster_resolver) module: Library Imports for Cluster Resolvers.

[`experimental`](../../../tf/compat/v2/distribute/experimental) module: Experimental Distribution Strategy library.
...
[`class Strategy`](../../../tf/compat/v2/distribute/Strategy): A list of devices with a state & compute distribution policy.
