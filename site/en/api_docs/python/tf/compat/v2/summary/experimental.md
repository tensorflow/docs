...
[`get_step(...)`](../../../../tf/compat/v2/summary/experimental/get_step): Returns the default summary step for the current thread.

[`set_step(...)`](../../../../tf/compat/v2/summary/experimental/set_step): Sets the default summary step for the current thread.
