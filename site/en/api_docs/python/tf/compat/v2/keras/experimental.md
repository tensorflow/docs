...
<td>
  <a target="_blank" href="/api_docs/python/tf/compat/v2/keras/experimental">
...
[`class CosineDecay`](../../../../tf/keras/experimental/CosineDecay): A LearningRateSchedule that uses a cosine decay schedule.

[`class CosineDecayRestarts`](../../../../tf/keras/experimental/CosineDecayRestarts): A LearningRateSchedule that uses a cosine decay schedule with restarts.
