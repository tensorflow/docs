...
Defined in [`python/keras/api/_v2/keras/losses/__init__.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/python/keras/api/_v2/keras/losses/__init__.py).
...
[`class MeanAbsolutePercentageError`](../../../../tf/keras/losses/MeanAbsolutePercentageError): Computes the mean absolute percentage error between `y_true` and `y_pred`.

[`class MeanSquaredError`](../../../../tf/keras/losses/MeanSquaredError): Computes the mean of squares of errors between labels and predictions.
...
[`class Reduction`](../../../../tf/compat/v2/keras/losses/Reduction): Types of loss reduction.
