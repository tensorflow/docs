...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/python/keras/estimator/__init__.py#L110-L187">
...
* <b>`checkpoint_format`</b>: Sets the format of the checkpoint saved by the estimator
  ...
  save checkpoints from <a href="../../../../../tf/train/Saver"><code>tf.compat.v1.train.Saver</code></a> or <a href="../../../../../tf/train/Checkpoint"><code>tf.train.Checkpoint</code></a>.
  The default is `checkpoint`. Estimators use name-based <a href="../../../../../tf/train/Saver"><code>tf.train.Saver</code></a>
