...
<td>
  <a target="_blank" href="/api_docs/python/tf/compat/v2">
...
[`case(...)`](../../tf/compat/v2/case): Create a case operation.
...
[`ones_like(...)`](../../tf/compat/v2/ones_like): Creates a tensor with all elements set to one.
