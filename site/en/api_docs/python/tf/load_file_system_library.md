...
Defined in [`tensorflow/python/framework/load_library.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/python/framework/load_library.py).
