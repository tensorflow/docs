...
Defined in [`tensorflow/python/ops/image_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/python/ops/image_ops.py).

Image processing and decoding ops.

See the [Images](../../../api_guides/python/image) guide.
