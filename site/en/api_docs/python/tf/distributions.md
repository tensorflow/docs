...
Defined in [`tensorflow/python/ops/distributions/distributions.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/ops/distributions/distributions.py).

Core module for TensorFlow distribution objects and helpers.

## Modules

[`bijectors`](../tf/distributions/bijectors) module: Core module for TensorFlow distribution bijectors.
