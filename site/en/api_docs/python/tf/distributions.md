...
Defined in [`tensorflow/python/ops/distributions/distributions.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/ops/distributions/distributions.py).
