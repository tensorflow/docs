...
Defined in [`tensorflow/python/summary/summary.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/python/summary/summary.py).

Tensor summaries for exporting information about a model.

See the [Summary Operations](../../../api_guides/python/summary) guide.
