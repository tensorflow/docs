...
[`make_initializable_iterator(...)`](../tf/data/make_initializable_iterator): Creates a <a href="../tf/data/Iterator"><code>tf.data.Iterator</code></a> for enumerating the elements of a dataset.

[`make_one_shot_iterator(...)`](../tf/data/make_one_shot_iterator): Creates a <a href="../tf/data/Iterator"><code>tf.data.Iterator</code></a> for enumerating the elements of a dataset.
