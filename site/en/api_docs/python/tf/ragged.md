...
* <a href="../tf/div_no_nan"><code>tf.div_no_nan</code></a>(**x**, **y**, name=`None`)
* <a href="../tf/dtypes/as_string"><code>tf.dtypes.as_string</code></a>(**input**, precision=`-1`, scientific=`False`, shortest=`False`, width=`-1`, fill=`''`, name=`None`)
...
* <a href="../tf/floormod"><code>tf.floormod</code></a>(**x**, **y**, name=`None`)
* <a href="../tf/gather_nd"><code>tf.gather_nd</code></a>(**params**, **indices**, name=`None`)
* <a href="../tf/gather"><code>tf.gather</code></a>(**params**, **indices**, validate_indices=`None`, name=`None`, axis=`0`)
