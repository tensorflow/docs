...
Defined in [`tensorflow/python/ops/partitioned_variables.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/ops/partitioned_variables.py).
