...
results to using <a href="../../tf/image/resize_bilinear"><code>tf.image.resize_bilinear()</code></a> or
<a href="../../tf/image/resize_nearest_neighbor"><code>tf.image.resize_nearest_neighbor()</code></a>(depends on the `method` argument) with
`align_corners=True`.
