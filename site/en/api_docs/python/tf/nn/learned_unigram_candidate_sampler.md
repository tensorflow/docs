...
Defined in [`tensorflow/python/ops/candidate_sampling_ops.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/ops/candidate_sampling_ops.py).
