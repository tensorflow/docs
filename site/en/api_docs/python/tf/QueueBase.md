...
See [`tf.FIFOQueue`](../tf/FIFOQueue) and
[`tf.RandomShuffleQueue`](../tf/RandomShuffleQueue) for concrete
...
<h3 id="__init__"><code>__init__(dtypes, shapes, names, queue_ref)</code></h3>
