...
Defined in [`tensorflow/python/summary/summary_iterator.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/python/summary/summary_iterator.py).
...
[Event](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/core/util/event.proto)
and
