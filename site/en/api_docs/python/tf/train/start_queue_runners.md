...
Defined in [`tensorflow/python/training/queue_runner_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/training/queue_runner_impl.py).
...
* <b>`ValueError`</b>: If called without a default `tf.Session` registered.
