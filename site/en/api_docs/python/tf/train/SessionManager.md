...
Defined in [`tensorflow/python/training/session_manager.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/training/session_manager.py).
