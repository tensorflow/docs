...
<h3 id="__init__"><code>__init__(local_init_op=None, ready_op=None, ready_for_local_init_op=None, graph=None, recovery_wait_secs=30)</code></h3>
...
<h3 id="prepare_session"><code>prepare_session(master, init_op=None, saver=None, checkpoint_dir=None, checkpoint_filename_with_path=None, wait_for_checkpoint=False, max_wait_secs=7200, config=None, init_feed_dict=None, init_fn=None)</code></h3>
...
<h3 id="recover_session"><code>recover_session(master, saver=None, checkpoint_dir=None, checkpoint_filename_with_path=None, wait_for_checkpoint=False, max_wait_secs=7200, config=None)</code></h3>
...
<h3 id="wait_for_session"><code>wait_for_session(master, config=None, max_wait_secs=float('Inf'))</code></h3>
