...
<h3 id="__init__"><code>__init__(save_steps=None, save_secs=None, output_dir=None, summary_writer=None, scaffold=None, summary_op=None)</code></h3>
...
<h3 id="end"><code>end(session=None)</code></h3>
