...
Defined in [`tensorflow/python/training/basic_session_run_hooks.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/training/basic_session_run_hooks.py).
...
* <b>`summary_op`</b>: `Tensor` of type `string` containing the serialized `Summary`
      ...
      by TF summary methods like <a href="../../tf/summary/scalar"><code>tf.summary.scalar</code></a> or
      <a href="../../tf/summary/merge_all"><code>tf.summary.merge_all</code></a>. It can be passed in as one tensor; if more
