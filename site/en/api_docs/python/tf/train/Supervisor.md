...
* Specifying `'local'` requests a session that uses the RPC-based
  ...
  [`tf.train.Server.create_local_server`](../../tf/train/Server#create_local_server) for
  details.
...
<h3 id="Loop"><code>Loop(timer_interval_secs, target, args=None, kwargs=None)</code></h3>
...
<h3 id="PrepareSession"><code>PrepareSession(master='', config=None, wait_for_checkpoint=False, max_wait_secs=7200, start_standard_services=True)</code></h3>
...
<h3 id="RequestStop"><code>RequestStop(ex=None)</code></h3>
...
<h3 id="StartQueueRunners"><code>StartQueueRunners(sess, queue_runners=None)</code></h3>
...
<h3 id="StartStandardServices"><code>StartStandardServices(sess)</code></h3>
...
<h3 id="Stop"><code>Stop(threads=None, close_summary_writer=True)</code></h3>
...
<h3 id="SummaryComputed"><code>SummaryComputed(sess, summary, global_step=None)</code></h3>
...
<h3 id="managed_session"><code>managed_session(*args, **kwds)</code></h3>
...
<h3 id="prepare_or_wait_for_session"><code>prepare_or_wait_for_session(master='', config=None, wait_for_checkpoint=False, max_wait_secs=7200, start_standard_services=True)</code></h3>
...
<h3 id="start_queue_runners"><code>start_queue_runners(sess, queue_runners=None)</code></h3>
...
<h3 id="start_standard_services"><code>start_standard_services(sess)</code></h3>
...
<h3 id="summary_computed"><code>summary_computed(sess, summary, global_step=None)</code></h3>
