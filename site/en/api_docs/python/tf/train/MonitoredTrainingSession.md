...
initialize/restore. Please check <a href="../../tf/train/MonitoredSession"><code>tf.train.MonitoredSession</code></a> for more
information.
...
* <b>`config`</b>: an instance of <a href="../../tf/ConfigProto"><code>tf.ConfigProto</code></a> proto used to configure the session.
    It's the `config` argument of constructor of <a href="../../tf/Session"><code>tf.Session</code></a>.
