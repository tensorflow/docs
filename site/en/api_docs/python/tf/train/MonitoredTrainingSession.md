...
initialize/restore. Please check <a href="../../tf/train/MonitoredSession"><code>tf.compat.v1.train.MonitoredSession</code></a> for
more
information.
...
* <b>`config`</b>: an instance of <a href="../../tf/ConfigProto"><code>tf.compat.v1.ConfigProto</code></a> proto used to configure
