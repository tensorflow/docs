...
Defined in [`tensorflow/python/training/proximal_adagrad.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/training/proximal_adagrad.py).
