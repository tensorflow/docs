...
Defined in [`tensorflow/python/training/proximal_adagrad.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/python/training/proximal_adagrad.py).
