...
Defined in [`tensorflow/python/training/device_setter.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/training/device_setter.py).
