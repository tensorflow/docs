...
Defined in [`tensorflow/python/training/saver.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/training/saver.py).
...
See <a href="../../../../programmers_guide/variables">Variables</a>
