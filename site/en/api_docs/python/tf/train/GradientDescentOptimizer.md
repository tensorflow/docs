...
Defined in [`tensorflow/python/training/gradient_descent.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/python/training/gradient_descent.py).
