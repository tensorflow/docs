...
Defined in [`tensorflow/python/training/gradient_descent.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/training/gradient_descent.py).
