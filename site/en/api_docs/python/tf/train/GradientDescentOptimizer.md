...
Defined in [`tensorflow/python/training/gradient_descent.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/training/gradient_descent.py).
