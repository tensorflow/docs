...
Defined in [`tensorflow/python/training/proximal_gradient_descent.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/training/proximal_gradient_descent.py).
