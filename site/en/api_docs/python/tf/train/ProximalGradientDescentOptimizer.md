...
Defined in [`tensorflow/python/training/proximal_gradient_descent.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/python/training/proximal_gradient_descent.py).
