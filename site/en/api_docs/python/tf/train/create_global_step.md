...
Defined in [`tensorflow/python/training/training_util.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/training/training_util.py).
