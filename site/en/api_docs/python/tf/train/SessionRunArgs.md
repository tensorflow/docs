...
Defined in [`tensorflow/python/training/session_run_hook.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/python/training/session_run_hook.py).
