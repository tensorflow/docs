...
Defined in [`tensorflow/python/training/sync_replicas_optimizer.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/python/training/sync_replicas_optimizer.py).
