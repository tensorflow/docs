...
Defined in [`tensorflow/python/training/sync_replicas_optimizer.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/training/sync_replicas_optimizer.py).
