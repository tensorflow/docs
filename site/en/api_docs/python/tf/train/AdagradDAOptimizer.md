...
<h3 id="__init__"><code>__init__(learning_rate, global_step, initial_gradient_squared_accumulator_value=0.1, l1_regularization_strength=0.0, l2_regularization_strength=0.0, use_locking=False, name='AdagradDA')</code></h3>
...
<h3 id="compute_gradients"><code>compute_gradients(loss, var_list=None, gate_gradients=GATE_OP, aggregation_method=None, colocate_gradients_with_ops=False, grad_loss=None)</code></h3>
...
<h3 id="get_slot"><code>get_slot(var, name)</code></h3>
