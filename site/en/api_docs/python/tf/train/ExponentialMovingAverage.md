...
*  Build a model normally but load the checkpoint files to evaluate by using
   ...
   the [`tf.train.Saver`](../../tf/train/Saver) for more
...
<h3 id="__init__"><code>__init__(decay, num_updates=None, zero_debias=False, name='ExponentialMovingAverage')</code></h3>
...
<h3 id="apply"><code>apply(var_list=None)</code></h3>
...
<h3 id="average"><code>average(var)</code></h3>
...
<h3 id="average_name"><code>average_name(var)</code></h3>
...
<h3 id="variables_to_restore"><code>variables_to_restore(moving_avg_variables=None)</code></h3>
