...
Defined in [`tensorflow/python/training/moving_averages.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/python/training/moving_averages.py).
