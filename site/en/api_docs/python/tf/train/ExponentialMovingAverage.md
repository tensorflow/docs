...
Defined in [`tensorflow/python/training/moving_averages.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/training/moving_averages.py).
