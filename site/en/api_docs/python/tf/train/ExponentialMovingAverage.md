...
Defined in [`tensorflow/python/training/moving_averages.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/training/moving_averages.py).
