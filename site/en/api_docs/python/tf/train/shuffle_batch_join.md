...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/python/training/input.py#L1414-L1509">
...
* <a href="/api_docs/python/tf/train/shuffle_batch_join"><code>tf.compat.v1.train.shuffle_batch_join</code></a>
...
Queue-based input pipelines have been replaced by <a href="../../tf/data"><code>tf.data</code></a>. Use `tf.data.Dataset.interleave(...).shuffle(min_after_dequeue).batch(batch_size)`.

The `tensors_list` argument is a list of tuples of tensors, or a list of
dictionaries of tensors.  Each element in the list is treated similarly
to the `tensors` argument of <a href="../../tf/train/shuffle_batch"><code>tf.compat.v1.train.shuffle_batch()</code></a>.
...
<a href="../../tf/errors/OutOfRangeError"><code>tf.errors.OutOfRangeError</code></a> if the input queue is exhausted. If this
