...
<h3 id="__init__"><code>__init__(target='', graph=None, config=None)</code></h3>
...
[`tf.Operation.run`](../tf/Operation#run) or
[`tf.Tensor.eval`](../tf/Tensor#eval) should be
...
<h3 id="reset"><code>reset(target, containers=None, config=None)</code></h3>
