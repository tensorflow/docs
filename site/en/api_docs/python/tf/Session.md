...
Defined in [`tensorflow/python/client/session.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/python/client/session.py).
...
[`tf.Variable`](../tf/Variable), [`tf.QueueBase`](../tf/QueueBase),
and [`tf.ReaderBase`](../tf/ReaderBase). It is important to release
these resources when they are no longer required. To do this, either
invoke the [`tf.Session.close`](../tf/Session#close) method on the session, or use
...
The [`ConfigProto`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/core/protobuf/config.proto)
...
* <b>`config`</b>: (Optional.) A [`ConfigProto`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/core/protobuf/config.proto)
...
[`tf.Session.run`](../tf/Session#run) for details of the allowable feed key and value types.
...
* <b>`fetches`</b>: A value or list of values to fetch. See [`tf.Session.run`](../tf/Session#run)
    for details of the allowable fetch types.
* <b>`feed_list`</b>: (Optional.) A list of `feed_dict` keys. See
    [`tf.Session.run`](../tf/Session#run) for details of the allowable feed key types.
...
* <b>`TypeError`</b>: If `fetches` or `feed_list` cannot be interpreted
    as arguments to [`tf.Session.run`](../tf/Session#run).
