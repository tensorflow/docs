...
Defined in [`tensorflow/python/framework/random_seed.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/framework/random_seed.py).
