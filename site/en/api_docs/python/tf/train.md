...
Defined in [`tensorflow/python/training/training.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/python/training/training.py).

Support for training models.

See the [Training](../../../api_guides/python/train) guide.
...
[`class FinalOpsHook`](../tf/train/FinalOpsHook): A run hook which evaluates `Tensors` at the end of a session.
