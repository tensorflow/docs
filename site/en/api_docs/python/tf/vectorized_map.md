...
Defined in [`python/ops/parallel_for/control_flow_ops.py`](https://github.com/tensorflow/tensorflow/tree/r1.14/tensorflow/python/ops/parallel_for/control_flow_ops.py).
