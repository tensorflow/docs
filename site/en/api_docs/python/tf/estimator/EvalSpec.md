...
<td>
  <a target="_blank" href="/api_docs/python/tf/estimator/EvalSpec">
...
* Class <a href="/api_docs/python/tf/estimator/EvalSpec"><code>tf.compat.v1.estimator.EvalSpec</code></a>
* Class <a href="/api_docs/python/tf/estimator/EvalSpec"><code>tf.compat.v2.estimator.EvalSpec</code></a>
...
* <b>`steps`</b>: Int. Positive number of steps for which to evaluate model. If
  ...
  See <a href="../../tf/estimator/Estimator#evaluate"><code>Estimator.evaluate</code></a> for details.
