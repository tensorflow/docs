...
Defined in [`tensorflow/python/estimator/canned/linear.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/estimator/canned/linear.py).
