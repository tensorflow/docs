...
* <b>`label_dtype`</b>: A `tf.dtype` identifies the type of labels. By default it is
    <a href="../../tf/dtypes#int64"><code>tf.int64</code></a>. If user defines a `label_vocabulary`, this should be set as
    <a href="../../tf/dtypes#string"><code>tf.string</code></a>. <a href="../../tf/dtypes#float32"><code>tf.float32</code></a> labels are only supported for binary
    classification.
