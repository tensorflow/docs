...
Defined in [`tensorflow/python/estimator/model_fn.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/python/estimator/model_fn.py).
...
* <b>`training_chief_hooks`</b>: A list of `tf.train.SessionRunHook` objects to
    run on the chief worker during training.
* <b>`training_hooks`</b>: A list of `tf.train.SessionRunHook` objects that to run on
