...
Defined in [`tensorflow/python/estimator/inputs/inputs.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/estimator/inputs/inputs.py).
