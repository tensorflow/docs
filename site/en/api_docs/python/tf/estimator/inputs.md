...
Defined in [`tensorflow/python/estimator/inputs/inputs.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/python/estimator/inputs/inputs.py).
