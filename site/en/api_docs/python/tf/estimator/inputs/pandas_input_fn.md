...
Defined in [`tensorflow/python/estimator/inputs/pandas_io.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/estimator/inputs/pandas_io.py).
