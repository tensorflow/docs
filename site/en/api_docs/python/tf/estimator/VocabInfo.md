...
Defined in [`tensorflow/python/estimator/warm_starting_util.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/estimator/warm_starting_util.py).
