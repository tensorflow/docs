...
See the guides: [Regression Examples > custom_regression.py](../../../../api_guides/python/regression_examples#custom_regression_py), [Regression Examples](../../../../api_guides/python/regression_examples)
...
The `config` argument can be passed <a href="../../tf/estimator/RunConfig"><code>tf.estimator.RunConfig</code></a> object containing
