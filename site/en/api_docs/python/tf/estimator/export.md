...
Defined in [`tensorflow/python/estimator/export/export_lib.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/python/estimator/export/export_lib.py).
