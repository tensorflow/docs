...
Defined in [`tensorflow/python/estimator/export/export_lib.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/estimator/export/export_lib.py).
