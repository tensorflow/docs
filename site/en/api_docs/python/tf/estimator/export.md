...
Defined in [`tensorflow/python/estimator/api/estimator/export/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.10/tensorflow/python/estimator/api/estimator/export/__init__.py).
