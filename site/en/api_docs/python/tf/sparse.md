...
[`matmul(...)`](../tf/sparse/matmul): Multiply SparseTensor (of rank 2) "A" by dense matrix "B".

[`maximum(...)`](../tf/sparse/maximum): Returns the element-wise max of two SparseTensors.

[`merge(...)`](../tf/sparse/merge): Combines a batch of feature ids and values into a single `SparseTensor`.
...
[`reduce_max(...)`](../tf/sparse/reduce_max): Computes the max of elements across dimensions of a SparseTensor. (deprecated arguments)
...
[`reduce_sum(...)`](../tf/sparse/reduce_sum): Computes the sum of elements across dimensions of a SparseTensor. (deprecated arguments)
