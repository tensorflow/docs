...
Defined in [`tensorflow/python/saved_model/utils_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/saved_model/utils_impl.py).
