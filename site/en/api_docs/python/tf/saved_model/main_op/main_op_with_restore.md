...
Defined in [`tensorflow/python/saved_model/main_op_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/python/saved_model/main_op_impl.py).
