...
Defined in [`tensorflow/python/saved_model/save.py`](https://github.com/tensorflow/tensorflow/blob/r1.13/tensorflow/python/saved_model/save.py).
...
Since <a href="../../../tf/keras/models/Model"><code>tf.keras.Model</code></a> objects are also Checkpointable, this function can be
...
<a href="../../../tf/keras/models/Model"><code>tf.keras.Model</code></a> instances constructed from inputs and outputs already have a
