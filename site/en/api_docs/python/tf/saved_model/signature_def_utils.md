...
Defined in [`tensorflow/python/saved_model/signature_def_utils.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/saved_model/signature_def_utils.py).
