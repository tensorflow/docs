...
Defined in [`tensorflow/python/saved_model/simple_save.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/saved_model/simple_save.py).
