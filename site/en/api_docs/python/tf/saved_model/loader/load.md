...
Defined in [`tensorflow/python/saved_model/loader_impl.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/saved_model/loader_impl.py).
