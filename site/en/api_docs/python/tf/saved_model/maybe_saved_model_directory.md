...
Defined in [`tensorflow/python/saved_model/loader_impl.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/saved_model/loader_impl.py).
