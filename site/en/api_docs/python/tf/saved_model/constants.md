...
Defined in [`tensorflow/saved_model/constants/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.9/tensorflow/saved_model/constants/__init__.py).
