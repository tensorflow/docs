...
Defined in [`tensorflow/python/feature_column/feature_column_lib.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/python/feature_column/feature_column_lib.py).
