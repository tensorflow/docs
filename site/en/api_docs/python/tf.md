...
Defined in [`tensorflow/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/__init__.py).
...
[`feature_column`](./tf/feature_column) module: FeatureColumns: tools for ingesting and representing features.
...
[`profiler`](./tf/profiler) module: profiler python module provides APIs to profile TensorFlow models.
...
[`quantize_v2(...)`](./tf/quantize_v2): Please use `tf.quantize` instead.
