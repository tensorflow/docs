...
Defined in [`tensorflow/python/debug/wrappers/grpc_wrapper.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/debug/wrappers/grpc_wrapper.py).
...
* <b>`sess`</b>: The `tf.Session` instance to be wrapped.
