...
### `class tfdbg.DebugTensorDatum`



Defined in [`tensorflow/python/debug/lib/debug_data.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/python/debug/lib/debug_data.py).
