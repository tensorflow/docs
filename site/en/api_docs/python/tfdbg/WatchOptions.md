...
Defined in [`tensorflow/python/debug/wrappers/framework.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/debug/wrappers/framework.py).
