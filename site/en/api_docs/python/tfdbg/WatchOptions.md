...
Defined in [`tensorflow/python/debug/wrappers/framework.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/python/debug/wrappers/framework.py).
