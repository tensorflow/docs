...
Defined in [`tensorflow/python/debug/wrappers/local_cli_wrapper.py`](https://github.com/tensorflow/tensorflow/blob/r1.12/tensorflow/python/debug/wrappers/local_cli_wrapper.py).
