...
Defined in [`tensorflow/python/debug/wrappers/local_cli_wrapper.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.8/tensorflow/python/debug/wrappers/local_cli_wrapper.py).
