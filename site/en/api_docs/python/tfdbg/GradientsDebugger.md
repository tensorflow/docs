...
Defined in [`tensorflow/python/debug/lib/debug_gradients.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.6/tensorflow/python/debug/lib/debug_gradients.py).
