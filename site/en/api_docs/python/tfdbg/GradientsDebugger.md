...
Defined in [`tensorflow/python/debug/lib/debug_gradients.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.7/tensorflow/python/debug/lib/debug_gradients.py).
