...
### `class tfdbg.GrpcDebugHook`



Defined in [`tensorflow/python/debug/wrappers/hooks.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.2/tensorflow/python/debug/wrappers/hooks.py).
