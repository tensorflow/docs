...
Defined in [`tensorflow/python/debug/__init__.py`](https://www.github.com/tensorflow/tensorflow/blob/r1.5/tensorflow/python/debug/__init__.py).

Public Python API of TensorFlow Debugger (tfdbg).

See the <a href="../../api_guides/python/tfdbg">TensorFlow Debugger</a> guide.
...
[`class TensorBoardDebugWrapperSession`](./tfdbg/TensorBoardDebugWrapperSession): A tfdbg Session wrapper that can be used with TensroBoard Debugger Plugin.
